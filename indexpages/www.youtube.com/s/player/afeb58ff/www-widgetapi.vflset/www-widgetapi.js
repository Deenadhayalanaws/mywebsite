(function() {
    ...
    */
    ...
    function Ba(a) {
        ...
        (b = a.l = a.l || b) ? b.Va ? a.i = a.s || a.o : void 0 != b.u && a.o < b.u ? (a.i = b.u, a.l = null) : a.i = a.o: a.i = 0
    }
    ...
    function Ea(a, b, c, d) {
        try {
            ...
            if (!e.done) return a.i.v = !1, e;
            var f = e.value
        } catch (g) {
            return a.i.m = null, wa(a.i, g), Fa(a)
        }
        a.i.m = null;
        d.call(a.i, f);
        return Fa(a)
    ...
    function Ga(a) {
        this.next = function(b) {
            ua(a.i);
            a.i.m ? b = Ea(a, a.i.m.next, b, a.i.H) : (a.i.H(b), b = Fa(a));
            return b
        };
        this.throw = function(b) {
            ua(a.i);
            a.i.m ? b = Ea(a, a.i.m["throw"], b, a.i.H) : (wa(a.i, b), b = Fa(a));
            return b
        };
    ...
    r("Promise", function(a) {
        ...
        b.prototype.fb = function(g) {
            ...
            "function" == typeof h ? this.jb(h, g) : this.s(g)
        };
        ...
        b.race = function(g) {
            return new b(function(h, k) {
                for (var l = u(g), m = l.next(); !m.done; m = l.next()) d(m.value).ra(h, k)
            })
        };
        b.all = function(g) {
            var h = u(g),
            ...
            return k.done ? d([]) : new b(function(l, m) {
                ...
                var t = [],
                    p = 0;
                do t.push(void 0), p++, d(k.value).ra(q(t.length - 1), m), k = h.next(); while (!k.done)
            })
        };
        return b
    });
    ...
    r("Map", function(a) {
        ...
        e.prototype.set = function(h, k) {
            ...
            l.entry ? l.entry.value = k : (l.entry = {
                ...
                key: h,
                value: k
            }, l.list.push(l.entry), this.i.previous.next = l.entry, this.i.previous = l.entry, this.size++);
            return this
        };
    ...
    function Yb(a) {
        if (a !== Xb) throw Error("requires a valid immutable API token");
    };
    ...
    var ec = E("Opera"),
        fc = E("Trident") || E("MSIE"),
        gc = E("Edge"),
        hc = E("Gecko") && !(-1 != Lb().toLowerCase().indexOf("webkit") && !E("Edge")) && !(E("Trident") || E("MSIE")) && !E("Edge"),
        ic = -1 != Lb().toLowerCase().indexOf("webkit") && !E("Edge");
    ...
    if (A.document && fc) {
        var qc = jc();
        pc = qc ? qc : parseInt(oc, 10) || void 0
    } else pc = void 0;
    var rc = pc;
    var sc = Zb() || E("iPod"),
        tc = E("iPad");
    !E("Android") || Mb();
    Mb();
    var uc = E("Safari") && !(Mb() || E("Coast") || E("Opera") || E("Edge") || E("Edg/") || E("OPR") || E("Firefox") || E("FxiOS") || E("Silk") || E("Android")) && !(Zb() || E("iPad") || E("iPod"));
    var vc = {},
        wc = null;
    ...
    function Cc(a) {
        if (zc !== zc) throw Error("illegal external caller");
        this.Ka = a;
    ...
    var Dc = "function" === typeof Symbol && "symbol" === typeof Symbol() ? Symbol(void 0) : void 0;

    function Ec(a, b) {
        Object.isFrozen(a) || (Dc ? a[Dc] |= b : void 0 !== a.W ? a.W |= b : Object.defineProperties(a, {
            W: {
                value: b,
                configurable: !0,
                writable: !0,
    ...
    function Gc(a) {
        return Array.isArray(a) ? !!(Fc(a) & 1) : !1
    }
    ...
    function Ic(a) {
        return Array.isArray(a) ? !!(Fc(a) & 2) : !1
    }
    ...
    function Kc(a, b) {
        ...
        b ? Ec(a, 8) : Object.isFrozen(a) || (Dc ? a[Dc] &= -9 : void 0 !== a.W && (a.W &= -9))
    };
    ...
    var Qc, Rc = Object.freeze(Hc([]));

    function Sc(a) {
        if (Lc(a)) throw Error("Cannot mutate an immutable Message");
    }
    var Tc = "undefined" != typeof Symbol && "undefined" != typeof Symbol.hasInstance;
        ...
        switch (typeof a) {
            ...
            case "object":
                if (a && !Array.isArray(a)) {
                    if (yc && null != a && a instanceof Uint8Array) return xc(a);
                    if (a instanceof Cc) {
                        var b = a.Ka;
                        null != b && "string" !== typeof b && (yc && b instanceof Uint8Array ? b = xc(b) : (La(b), b = null));
    ...
    function ad(a, b) {
        for (var c = a.slice(), d = 0; d < c.length; d++) c[d] = bd(c[d], b);
        Gc(a) && Hc(c);
        return c
    }
    ...
    function dd(a) {
        return a.j || (a.j = a.C[a.l + a.V] = {})
    }

    function ed(a, b, c) {
        return -1 === b ? null : b >= a.l ? a.j ? a.j[b] : void 0 : (void 0 === c ? 0 : c) && a.j && (c = a.j[b], null != c) ? c : a.C[b + a.V]
    }

    function F(a, b, c, d, e) {
        d = void 0 === d ? !1 : d;
        (void 0 === e ? 0 : e) || Sc(a);
        b < a.l && !d ? (a.C[b + a.V] = c, void 0 !== a.j && b in a.j && delete a.j[b]) : dd(a)[b] = c;
        return a
    }
    ...
    function fd(a, b, c, d) {
        c = void 0 === c ? !0 : c;
        var e = ed(a, b, d);
        Array.isArray(e) || (e = Rc);
        if (Lc(a)) c && (Jc(e), Object.freeze(e));
        else if (e === Rc || Ic(e)) e = Hc(e.slice()), F(a, b, e, d);
        return e
    }

    function gd(a, b, c, d) {
        Sc(a);
        (c = hd(a, c)) && c !== b && null != d && (a.i && c in a.i && (a.i[c] = void 0), F(a, c));
        return F(a, b, d)
    }
    ...
    function hd(a, b) {
        for (var c = 0, d = 0; d < b.length; d++) {
            var e = b[d];
            null != ed(a, e) && (0 !== c && F(a, c, void 0, !1, !0), c = e)
        }
        return c
    }
    ...
    function id(a, b, c, d) {
        ...
        var f = a.i[c];
        if (f) b = f;
        else if (b = Xc(ed(a, c, e), b)) a.i[c] = b, Lc(a) && Jc(b.C);
        if (null == b) return b;
        Lc(b) && !Lc(a) && (b = b.Ja(), F(a, c, b.C, d), a.i[c] = b);
        return b
    }
    ...
    function jd(a, b, c, d, e) {
        ...
        b = h || e;
        e = Ic(g);
        b && !e && (Object.isFrozen(g) && (a.i[c] = g = g.slice()), Jc(g), Object.freeze(g));
        !b && e && (a.i[c] = g = g.slice());
        return g
    }
    ...
    function ld(a, b, c, d) {
        ...
        if (null != d) {
            var e = Hc([]);
            for (var f = !1, g = 0; g < d.length; g++) e[g] = Wc(d[g], b).C, f = f || Ic(e[g]);
            a.i || (a.i = {});
            a.i[c] = d;
            Kc(e, !f)
        } else a.i && (a.i[c] = void 0), e = Rc;
        return F(a, c, e)
    }

    function md(a, b, c, d) {
        Sc(a);
        var e = jd(a, c, b, void 0, !1);
    ...
    function od(a, b, c) {
        ...
        a || (a = d ? [d] : []);
        this.V = (d ? 0 : -1) - (this.constructor.i || 0);
        this.i = void 0;
        this.C = a;
        a: {
            d = this.C.length;a = d - 1;
            if (d && (d = this.C[a], Pc(d))) {
                this.l = a - this.V;
                this.j = d;
                break a
            }
            void 0 !== b && -1 < b ? (this.l = Math.max(b, a + 1 - this.V), this.j = void 0) : this.l = Number.MAX_VALUE
        }
        if (c)
            for (b = 0; b < c.length; b++)
                if (a = c[b], a < this.l) a += this.V, (d = this.C[a]) ? Array.isArray(d) && Hc(d) : this.C[a] = Rc;
                else {
                    d = dd(this);
                    var e = d[a];
                    e ? Array.isArray(e) && Hc(e) : d[a] = Rc
                }
    }
                ...
                if (e) {
                    ...
                    if (Array.isArray(e)) {
                        if (e.length) {
                            ...
                            if (!(h = f) && (h = g)) {
                                h = g;
                                if (!Array.isArray(h)) throw Error("cannot check mutability state of non-array");
                                h = !(Fc(h) & 8)
                            }
                            if (h) {
                                for (h = 0; h < k.length; h++)(l = k[h]) && Lc(l) && !f && (k[h] = k[h].Ja(), g[h] = k[h].C);
                                Kc(g, !0)
                            }
                            f = k;
                            for (k = 0; k < Math.min(f.length, e.length); k++) sd(f[k], e[k])
                        }
                    } else(f =
    ...
    if (Tc) {
        var ud = {};
        Object.defineProperties(td, (ud[Symbol.hasInstance] = Uc(function() {
            throw Error("Cannot perform instanceof checks for MutableMessage");
        }), ud))
    };

    function vd(a, b, c, d, e, f) {
        (a = a.i && a.i[c]) ? Array.isArray(a) ? (e = f.Ba ? Hc(a.slice()) : a, ld(b, 0 < e.length ? e[0].constructor : void 0, c, e)) : H(b, a.constructor, c, a): (yc && d instanceof Uint8Array ? e = d.length ? new Cc(new Uint8Array(d)) : Bc || (Bc = new Cc(null)) : (Array.isArray(d) && (e ? Jc(d) : Gc(d) && f.Ba && (d = d.slice())), e = d), F(b, c, e))
    };
    ...
    I.prototype.Ja = function() {
        if (Lc(this)) {
            ...
            var b = Lc(this);
            if (b && !a.Ba) throw Error("copyRepeatedFields must be true for frozen messages");
            var c = new this.constructor;
            this.ia && (c.ia = this.ia.slice());
            for (var d = this.C, e = 0; e < d.length; e++) {
                var f = d[e];
                if (e === d.length - 1 && Pc(f))
                    for (var g in f) {
                        var h = +g;
                        Number.isNaN(h) ? dd(c)[g] = f[g] : vd(this, c, h, f[g], b, a)
                    } else vd(this, c, e - this.V, f, b, a)
            }
            a = c
        } else a = this;
        return a
    ...
    if (Tc) {
        var wd = {};
        Object.defineProperties(I, (wd[Symbol.hasInstance] = Uc(Object[Symbol.hasInstance]), wd))
    };
    var xd = window;
    yb("csi.gstatic.com");
    ...
    */
    ...
    function Ad(a, b) {
        ...
        if (b instanceof Ib) b instanceof Ib && b.constructor === Ib ? b = b.i : (La(b), b = "type_error:SafeUrl");
        else {
            a: if (zd) {
                try {
                    var c = new URL(b)
                ...
                c = -1 !== [":", ""].indexOf(c.protocol) ? "https:" : c.protocol
            }
            b = "javascript:" === c ? "about:invalid" : b
        }
        a.src = b;
    ...
    var Md = [Ld("data"), Ld("http"), Ld("https"), Ld("mailto"), Ld("ftp"), new Kd(function(a) {
        return /^[^:]*([/?#]|$)/.test(a)
    })];
    ...
    function Nd(a, b) {
        ...
        for (var c = 0; c < b.length; ++c) {
            var d = b[c];
            if (d instanceof Kd && d.isValid(a)) return new Ib(a, Jb)
        }
    }
    ...
    var Rd = "client_dev_domain client_dev_regex_map client_dev_root_url client_rollout_override expflag forcedCapability jsfeat jsmode mods".split(" ");
    ia(Rd);
    ...
    function Sd() {
        ...
        function b(q) {
            for (var t = g, p = 0; 64 > p; p += 4) t[p / 4] = q[p] << 24 | q[p + 1] << 16 | q[p + 2] << 8 | q[p + 3];
            for (p = 16; 80 > p; p++) q = t[p - 3] ^ t[p - 8] ^ t[p - 14] ^ t[p - 16], t[p] = (q << 1 | q >>> 31) & 4294967295;
            q = e[0];
            var y = e[1],
                z = e[2],
                G = e[3],
            ...
            for (p = 0; 80 > p; p++) {
                if (40 > p)
                    if (20 > p) {
                        var M = G ^ y & (z ^ G);
                        var O = 1518500249
                    } else M = y ^ z ^ G, O = 1859775393;
                else 60 > p ? (M = y & z | G & (y | z), O = 2400959708) : (M = y ^ z ^ G, O = 3395469782);
                M = ((q << 5 | q >>> 27) & 4294967295) + M + K + O + t[p] & 4294967295;
                K = G;
                G = z;
        ...
        function c(q, t) {
            ...
            for (; p < t;)
                if (f[l++] = q[p++], m++, 64 == l)
                    for (l = 0, b(f); p + 64 < t;) b(q.slice(p, p + 64)), p += 64, m += 64
        }
        ...
        function d() {
            ...
            b(f);
            for (p = t = 0; 5 > p; p++)
                for (var y = 24; 0 <= y; y -= 8) q[t++] = e[p] >> y & 255;
            return q
        }
        ...
        return {
            ...
            digest: d,
            mb: function() {
                for (var q = d(), t = "", p = 0; p < q.length; p++) t += "0123456789ABCDEF".charAt(Math.floor(q[p] / 16)) + "0123456789ABCDEF".charAt(q[p] % 16);
                return t
            }
        }
    };
    ...
    n.clear = function() {
        for (var a = (this.i.cookie || "").split(";"), b = [], c = [], d, e, f = 0; f < a.length; f++) e = Ab(a[f]), d = e.indexOf("="), -1 == d ? (b.push(""), c.push(e)) : (b.push(e.substring(0, d)), c.push(e.substring(d + 1)));
        for (a = b.length - 1; 0 <= a; a--) this.remove(b[a])
    };
    var $d = new Zd("undefined" == typeof document ? null : document);
    ...
    function ce(a) {
        ...
        e && (e = (c = 0 == c.indexOf("https:") || 0 == c.indexOf("chrome-extension:") || 0 == c.indexOf("moz-extension:")) ? A.__SAPISID : A.__APISID, e || (e = new Zd(document),
            e = e.get(c ? "SAPISID" : "APISID") || e.get("__Secure-3PAPISID")), (e = e ? Vd(e, c ? "SAPISIDHASH" : "APISIDHASH", a) : null) && d.push(e), c && ae(b) && ((b = be("__1PSAPISID", "__Secure-1PAPISID", "SAPISID1PHASH", a)) && d.push(b), (a = be("__3PSAPISID", "__Secure-3PAPISID", "SAPISID3PHASH", a)) && d.push(a)));
        ...
        if (!(!c && a.lineNumber && a.fileName && a.stack && a.message && a.name)) {
            ...
            if (null ==
                ...
                if (a.constructor && a.constructor instanceof Function) {
                    ...
                    else if (c = a.constructor, he[c]) c = he[c];
                    else {
                        c = String(c);
                        if (!he[c]) {
                            var f = /function\s+([^\(]+)/m.exec(c);
                            he[c] = f ? f[1] : "[Anonymous]"
                        }
                        c = he[c]
                    }
    ...
    qe.prototype.add = function(a, b, c, d, e) {
        ...
        var g = re(a, b, d, e); - 1 < g ? (b = a[g], c || (b.qa = !1)) : (b = new oe(b, this.src, f, !!d, e), b.qa = c, a.push(b));
        return b
    };
    qe.prototype.remove = function(a, b, c, d) {
        ...
        b = re(e, b, c, d);
        return -1 < b ? (pe(e[b]), Array.prototype.splice.call(e, b, 1), 0 == e.length && (delete this.listeners[a], this.i--), !0) : !1
    };

    function se(a, b) {
        var c = b.type;
        c in a.listeners && eb(a.listeners[c], b) && (pe(b), 0 == a.listeners[c].length && (delete a.listeners[c], a.i--))
    }

    function re(a, b, c, d) {
        for (var e = 0; e < a.length; ++e) {
            var f = a[e];
            if (!f.ka && f.listener == b && f.capture == !!c && f.va == d) return e
        }
        return -1
    };
    ...
    function we(a, b, c, d, e) {
        if (d && d.once) xe(a, b, c, d, e);
        else if (Array.isArray(b))
            for (var f = 0; f < b.length; f++) we(a, b[f], c, d, e);
        else c = ye(c), a && a[me] ? a.X(b, c, Pa(d) ? !!d.capture : !!d, e) : ze(a, b, c, !1, d, e)
    }
    ...
    function ze(a, b, c, d, e, f) {
        ...
        if (!c.proxy) {
            ...
            d.src = a;
            d.listener = c;
            if (a.addEventListener) je || (e = g), void 0 === e && (e = !1), a.addEventListener(b.toString(), d, e);
    ...
    function xe(a, b, c, d, e) {
        ...
        else c = ye(c), a && a[me] ? a.i.add(String(b), c, !0, Pa(d) ? !!d.capture : !!d, e) : ze(a, b, c, !0, d, e)
    }

    function Ee(a, b, c, d, e) {
        if (Array.isArray(b))
            for (var f = 0; f < b.length; f++) Ee(a, b[f], c, d, e);
        else(d = Pa(d) ? !!d.capture : !!d, c = ye(c), a && a[me]) ? a.i.remove(String(b), c, d, e) : a && (a = Ae(a)) && (b = a.listeners[b.toString()], a = -1, b && (a = re(b, c, d, e)), (c = -1 < a ? b[a] : null) && Fe(c))
    }
    ...
    function Fe(a) {
        if ("number" !== typeof a && a && !a.ka) {
            ...
            if (b && b[me]) se(b.i, a);
                ...
                var c = a.type,
                    d = a.proxy;
                b.removeEventListener ? b.removeEventListener(c, d, a.capture) : b.detachEvent ? b.detachEvent(Ce(c), d) : b.addListener && b.removeListener && b.removeListener(d);
                ve--;
                (c = Ae(b)) ? (se(c, a), 0 == c.i && (c.src = null, b[te] = null)) : pe(a)
            }
        }
    }
    ...
    Wa(He, de);
    He.prototype[me] = !0;
    He.prototype.addEventListener = function(a, b, c, d) {
        we(this, a, b, c, d)
    };
    He.prototype.removeEventListener = function(a, b, c, d) {
        Ee(this, a, b, c, d)
    };
    ...
    function Ie(a, b) {
        ...
        a = a.ea;
        c = b.type || b;
        "string" === typeof b ? b = new ee(b, a) : b instanceof ee ? b.target = b.target || a : (e = b, b = new ee(c, a), qb(b, e));
        e = !0;
        if (d)
        ...
        b.l || (g = b.i = a, e = Je(g, c, !0, b) && e, b.l || (e = Je(g, c, !1, b) && e));
        if (d)
            for (f = 0; !b.l && f < d.length; f++) g = b.i = d[f], e = Je(g, c, !1, b) && e
    }
    He.prototype.ha = function() {
        ...
        if (this.i) {
            ...
            for (c in a.listeners) {
                for (var d = a.listeners[c], e = 0; e < d.length; e++) ++b, pe(d[e]);
    ...
    He.prototype.X = function(a, b, c, d) {
    ...
    function Ke(a) {
        ...
        window.addEventListener("offline", this.s);
        window.addEventListener("online", this.s);
        this.J || Me(this)
    }
    v(Ke, He);
    ...
    Ke.prototype.dispose = function() {
        window.removeEventListener("offline", this.s);
        window.removeEventListener("online", this.s);
        this.K.Z(this.J);
        delete Ke.i
    };
    ...
    function Me(a) {
        a.J = a.K.O(function() {
            var b;
            return x(function(c) {
                if (1 == c.i) return a.j ? (null == (b = window.navigator) ? 0 : b.onLine) ? c.u(3) : w(c, Le(a), 3) : w(c, Le(a), 3);
                Me(a);
                c.i = 0
            })
        }, 3E4)
    ...
    function Le(a, b) {
        return a.v ? a.v : a.v = new Promise(function(c) {
            var d, e, f, g;
            return x(function(h) {
                switch (h.i) {
                    case 1:
                        return d = window.AbortController ? new window.AbortController : void 0, f = null == (e = d) ? void 0 : e.signal, g = !1, xa(h, 2, 3), d && (a.m = a.K.O(function() {
                            d.abort()
                    ...
                    case 3:
                        ...
                        a.v = void 0;
                        a.m && (a.K.Z(a.m), a.m = 0);
                        g !== a.j && (a.j = g, a.j ? Ie(a, "networkstatus-online") : Ie(a, "networkstatus-offline"));
                        c(g);
                        Ba(h);
                        break;
                    case 2:
    ...
    function ff() {
        var a, b;
        return null != (b = null == (a = df()) ? void 0 : a.then(function(c) {
            return ef(c)
        })) ? b : null
    };
    ...
    yf.prototype.update = function(a, b) {
        if (null != a) {
            void 0 === b && (b = a.length);
            for (var c = b - this.blockSize, d = 0, e = this.o, f = this.j; d < b;) {
                if (0 == f)
                    for (; d <= c;) zf(this, a, d), d += this.blockSize;
                if ("string" === typeof a)
                    for (; d < b;) {
    ...
    Af.prototype.L = function() {
        return this
    };

    function Df(a) {
        if (a instanceof Ef || a instanceof Ff || a instanceof Gf) return a;
        if ("function" == typeof a.next) return new Ef(function() {
            return a
        });
        if ("function" == typeof a[Symbol.iterator]) return new Ef(function() {
            return a[Symbol.iterator]()
        });
        if ("function" == typeof a.L) return new Ef(function() {
            return a.L()
        });
    ...
    function Hf(a, b) {
        ...
        if (1 < c) {
            ...
            if (a instanceof Hf)
                for (c = If(a), d = 0; d < c.length; d++) this.set(c[d], a.get(c[d]));
            else
    ...
    n.delete = function(a) {
        return Kf(this.j, a) ? (delete this.j[a], --this.size, this.l++, this.i.length > 2 * this.size && Jf(this), !0) : !1
    };
    ...
    function Jf(a) {
        ...
        if (a.size != a.i.length) {
            var e = {};
            for (c = b = 0; b < a.i.length;) d = a.i[b], Kf(e, d) || (a.i[c++] = d, e[d] = 1), b++;
            a.i.length = c
        }
    }
    n.get = function(a, b) {
        return Kf(this.j, a) ? this.j[a] : b
    };
    n.set = function(a, b) {
        Kf(this.j, a) || (this.size += 1, this.i.push(a), this.l++);
        this.j[a] = b
    };
    n.forEach = function(a, b) {
        for (var c = If(this), d = 0; d < c.length; d++) {
            var e = c[d],
                f = this.get(e);
            a.call(b, f, e, this)
        }
    ...
    n.keys = function() {
        return Df(this.L(!0)).i()
    };
    n.values = function() {
        return Df(this.L(!1)).i()
    };
    n.entries = function() {
        var a = this;
    ...
    Of.prototype.then = function(a, b, c) {
        return pg(this, "function" === typeof a ? a : null, "function" === typeof b ? b : null, c)
    };
    Of.prototype.$goog_Thenable = !0;
    Of.prototype.cancel = function(a) {
        if (0 == this.i) {
            var b = new qg(a);
            sf(function() {
                rg(this, b)
        ...
        if (0 == a.i)
            if (a.l) {
                ...
                if (c.j) {
                    ...
                    e && (0 == c.i && 1 == d ? rg(c, b) : (f ? (d = f, d.next == c.m && (c.m = d), d.next = d.next.next) : sg(c), tg(c, e, 3, b)))
                }
                a.l = null
            } else Pf(a, 3, b)
    }
    ...
    function ug(a, b) {
        a.j || 2 != a.i && 3 != a.i || vg(a);
        a.m ? a.m.next = b : a.j = b;
        a.m = b
    }

    function pg(a, b, c, d) {
        var e = og(null, null, null);
        e.i = new Of(function(f, g) {
            e.j = b ? function(h) {
                try {
                    var k = b.call(d, h);
                    f(k)
            ...
            e.onRejected = c ? function(h) {
                try {
                    var k = c.call(d, h);
                    void 0 === k && h instanceof qg ? g(h) : f(k)
                } catch (l) {
                    g(l)
                }
            } : g
    ...
    function Pf(a, b, c) {
        if (0 == a.i) {
            ...
            g || (a.v = c, a.i = b, a.l = null, vg(a), 3 != b || c instanceof qg || xg(a, c))
        }
    }
    ...
    Of.prototype.H = function() {
        for (var a; a = sg(this);) tg(this, a, this.i, this.v);
        this.s = !1
    };
    ...
    function tg(a, b, c, d) {
        ...
        if (b.i) b.i.l = null, yg(b, c, d);
        else try {
            b.l ? b.j.call(b.context) : yg(b, c, d)
        } catch (e) {
            zg.call(null, e)
        }
        hf(ng, b)
    ...
    n.oa = function(a) {
        ...
        if (b) {
            var c = this.j[b];
            0 != this.s ? (this.m.push(a), this.i[a + 1] = function() {}) : (c && eb(c, a), delete this.i[a], delete this.i[a + 1], delete this.i[a + 2])
        }
        return !!b
    };
    n.da = function(a, b) {
    ...
    n.clear = function(a) {
        if (a) {
            var b = this.j[a];
            b && (b.forEach(this.oa, this), delete this.j[a])
    ...
    Dg.prototype.set = function(a, b) {
        void 0 === b ? this.i.remove(a) : this.i.set(a, Mf(b))
    };
    ...
    function Gg(a) {
        return void 0 === a || a instanceof Fg ? a : new Fg(a)
    }
    Eg.prototype.set = function(a, b) {
        Eg.N.set.call(this, a, Gg(b))
    };
    Eg.prototype.j = function(a) {
        a = Eg.N.get.call(this, a);
    ...
    Wa(Hg, Eg);
    Hg.prototype.set = function(a, b, c) {
        if (b = Gg(b)) {
            if (c) {
                if (c < Date.now()) {
        ...
        Hg.N.set.call(this, a, b)
    };
    Hg.prototype.j = function(a) {
        var b = Hg.N.j.call(this, a);
        if (b) {
            var c = b.creation,
                d = b.expiration;
            if (d && d < Date.now() || c && c > Date.now()) Hg.prototype.remove.call(this, a);
            else return b
        }
    };
    ...
    function Mg(a, b) {
        ...
        this.i = null;
        var c;
        if (c = fc) c = !(9 <= Number(rc));
        if (c) {
            Ng || (Ng = new Hf);
            this.i = Ng.get(a);
            this.i || (b ? this.i = document.getElementById(b) : (this.i = document.createElement("userdata"), this.i.addBehavior("#default#userData"), document.body.appendChild(this.i)), Ng.set(a, this.i));
            try {
                this.i.load(this.j)
            } catch (d) {
                this.i = null
    ...
    n.set = function(a, b) {
        this.i.setAttribute(Pg(a), b);
        Qg(this)
    };
    n.get = function(a) {
        a = this.i.getAttribute(Pg(a));
        if ("string" !== typeof a && null !== a) throw "Storage mechanism: Invalid value was encountered";
        return a
    };
    n.remove = function(a) {
        this.i.removeAttribute(Pg(a));
        Qg(this)
    };
    n.L = function(a) {
        var b = 0,
        ...
        d.next = function() {
            if (b >= c.length) return Bf;
            var e = c[b++];
            if (a) return Cf(decodeURIComponent(e.nodeName.replace(/\./g, "%")).slice(1));
            e = e.nodeValue;
            if ("string" !== typeof e) throw "Storage mechanism: Invalid value was encountered";
            return Cf(e)
        };
    ...
    Rg.prototype.L = function(a) {
        ...
        d.next = function() {
            ...
            return Cf(a ? e.slice(c.i.length) : c.j.get(e))
        };
        return d
    };
    ...
    v(Sg, I);
    Sg.prototype.getKey = function() {
        return ed(this, 1)
    };
    Sg.prototype.T = function() {
        return ed(this, 2 === hd(this, Tg) ? 2 : -1)
    };
    Sg.prototype.setValue = function(a) {
        return gd(this, 2, Tg, a)
    };
    var Tg = [2, 3, 4, 5, 6];
    ...
    v(Yg, I);
    Yg.prototype.getPlayerType = function() {
        return ed(this, 36)
    };
    Yg.prototype.setHomeGroupInfo = function(a) {
        return H(this, Wg, 81, a)
    };
    var Zg = [9, 66, 24, 32, 86, 100, 101];
    ...
    v(bh, I);
    bh.prototype.setToken = function(a) {
        return F(this, 2, a)
    };
    ...
    v(ch, I);
    ch.prototype.setSafetyMode = function(a) {
        return F(this, 5, a)
    };
    var dh = [12];
    ...
    v(ih, I);
    ih.prototype.getKey = function() {
        return nd(this, 1)
    };
    ih.prototype.T = function() {
        return nd(this, 2)
    };
    ih.prototype.setValue = function(a) {
        return F(this, 2, a)
    };
    var hh = [4, 5];
    ...
    var vh = [23, 24, 11, 6, 7, 5, 2, 3, 13, 20, 21, 22, 28, 32, 37, 229, 241, 45, 59, 225, 288, 72, 73, 78, 208, 156, 202, 215, 74, 76, 79, 80, 111, 85, 91, 97, 100, 102, 105, 119, 126, 127, 136, 146, 148, 151, 157, 158, 159, 163, 164, 168, 176, 222, 383, 177, 178, 179, 411, 184, 188, 189, 190, 191, 193, 194, 195, 196, 197, 198, 199, 200, 201, 402, 320, 203, 204, 205, 206, 258, 259, 260, 261, 327, 209, 219, 226, 227, 232, 233, 234, 240, 244, 247, 248, 249, 251, 256, 257, 266, 254, 255, 270, 272, 278, 291, 293, 300, 304, 308, 309, 310, 311, 313, 314, 319, 321, 323, 324, 328, 330, 331, 332, 334, 337, 338, 340, 344, 348, 350, 351, 352,
        353, 354, 355, 356, 357, 358, 361, 363, 364, 368, 369, 370, 373, 374, 375, 378, 380, 381, 388, 389, 403, 410, 412, 429, 413, 414, 415, 416, 417, 418, 430, 423, 424, 425, 426, 427, 431, 117
    ];
    ...
    v(xh, I);
    xh.prototype.setVideoId = function(a) {
        return gd(this, 1, yh, a)
    };
    xh.prototype.getPlaylistId = function() {
        return ed(this, 2 === hd(this, yh) ? 2 : -1)
    };
    var yh = [1, 2];
    ...
    var Ah = [3];
    var Bh = A.window,
        Ch, Dh, Eh = (null == Bh ? void 0 : null == (Ch = Bh.yt) ? void 0 : Ch.config_) || (null == Bh ? void 0 : null == (Dh = Bh.ytcfg) ? void 0 : Dh.data_) || {};
    C("yt.config_", Eh);

    function Fh() {
        var a = arguments;
        1 < a.length ? Eh[a[0]] = a[1] : 1 === a.length && Object.assign(Eh, a[0])
    }

    function L(a, b) {
        return a in Eh ? Eh[a] : b
    }

    function Gh() {
        return L("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS")
    }

    function Hh() {
        var a = Eh.EXPERIMENT_FLAGS;
        return a ? a.web_disable_gel_stp_ecatcher_killswitch : void 0
    };
    var Ih = [];

    function Jh(a) {
        Ih.forEach(function(b) {
            return b(a)
        })
    }
    ...
    function Lh(a, b, c, d) {
        ...
        e ? e(a, "ERROR", b, c, d) : (e = L("ERRORS", []), e.push([a, "ERROR", b, c, d]), Fh("ERRORS", e));
        Jh(a)
    }

    function Mh(a, b, c, d) {
        var e = B("yt.logging.errors.log");
        e ? e(a, "WARNING", b, c, d) : (e = L("ERRORS", []), e.push([a, "WARNING", b, c, d]), Fh("ERRORS", e))
    };
    var Nh = 0;
    ...
    function Ph(a) {
        ...
        try {
            if (a = a || window.event) {
                this.event = a;
                for (var b in a) b in Oh || (this[b] = a[b]);
    ...
    Ph.prototype.stopImmediatePropagation = function() {
    ...
    var Qh = A.ytEventsEventsCounter || {
        count: 0
    };
    C("ytEventsEventsCounter", Qh);
        ...
        a && ("string" == typeof a && (a = [a]), D(a, function(b) {
            if (b in kb) {
                var c = kb[b],
                    ...
                    f = c[3];
                c = c[4];
                d.removeEventListener ? Th() || "boolean" === typeof c ? d.removeEventListener(e, f, c) : d.removeEventListener(e, f, !!c.capture) : d.detachEvent && d.detachEvent("on" + e, f);
                delete kb[b]
            }
        }))
    }
    ...
    function Uh(a, b, c) {
        ...
        if (a && (a.addEventListener || a.attachEvent)) {
            ...
            if (!e) {
                ...
                var g = f ? function(h) {
                    h = new Ph(h);
                    if (!Dd(h.relatedTarget, function(k) {
                            return k == a
                ...
                g = Kh(g);
                a.addEventListener ? ("mouseenter" == b && f ? b = "mouseover" : "mouseleave" == b && f ? b = "mouseout" : "mousewheel" == b && "MozBoxSizing" in document.documentElement.style && (b = "MozMousePixelScroll"), Th() || "boolean" === typeof d ? a.addEventListener(b, g, d) : a.addEventListener(b, g, !!d.capture)) : a.attachEvent("on" + b, g);
                kb[e] = [a, b, c, g, d]
            }
        }
    };
        ...
        for (var c = {}, d = 0, e = b.length; d < e; d++) {
            ...
            if (1 == f.length && f[0] || 2 == f.length) try {
                ...
                k.args = [{
                    ...
                    value: f[1],
                    query: a,
                    method: ai == m ? "unchanged" : m
                }];
                Yh.hasOwnProperty(l) || Mh(k)
            }
        }
        return c
    }
    ...
    function ei(a) {
        ...
        var c = a.match(Pb)[1] || null,
            d = Rb(a);
        c && d ? (a = a.match(Pb), b = b.match(Pb), a = a[3] == b[3] && a[1] == b[1] && a[4] == b[4]) : a = d ? Rb(b) == d && (Number(b.match(Pb)[4] || null) || null) == (Number(a.match(Pb)[4] || null) || null) : !0;
        return a
    }

    function $h(a) {
        return a && a.match(Xh) ? a : decodeURIComponent(a.replace(/\+/g, " "))
    };
    ...
    function ii(a) {
        ...
        try {
            ...
            var q;
            e.u_aw = null ==
                (q = xd.screen) ? void 0 : q.availWidth;
            var t;
        ...
        try {
            var Ac = h.screen.availWidth;
            var va = h.screen.availTop
        } catch (W) {}
        p = [O, nb, p, y, Ac, va, z, G, K, M];
        y = b.i.top;
        try {
            var pa = (y || window).document,
                X = "CSS1Compat" ==
                pa.compatMode ? pa.documentElement : pa.body;
            var ca = (new Bd(X.clientWidth, X.clientHeight)).round()
        } catch (W) {
            ca = new Bd(-12245933, -12245933)
        }
        pa = ca;
        ca = {};
        var da = void 0 === da ? A : da;
        X = new Pe;
        da.SVGElement && da.document.createElementNS && X.set(0);
        y = Id();
        y["allow-top-navigation-by-user-activation"] && X.set(1);
        y["allow-popups-to-escape-sandbox"] && X.set(2);
        da.crypto && da.crypto.subtle && X.set(3);
        da.TextDecoder && da.TextEncoder && X.set(4);
        da = Qe(X);
        ca.bc = da;
        ca.bih = pa.height;
        ca.biw = pa.width;
        ...
        b = (ca.vis =
            b.prerendering ? 3 : {
                ...
                preview: 4,
                unloaded: 5
            }[b.visibilityState || b.webkitVisibilityState || b.mozVisibilityState || ""] || 0, ca.wgl = !!xd.WebGLRenderingContext, ca);
        c = d.call(c, e, b);
        c.ca_type = "image";
        a && (c.bid = a);
        return c
    ...
    Date.now();
    var ki = "XMLHttpRequest" in A ? function() {
    ...
    var mi = {
        ...
        ni = "app debugcss debugjs expflag force_ad_params force_ad_encrypted force_viral_ad_response_params forced_experiments innertube_snapshots innertube_goldens internalcountrycode internalipoverride absolute_experiments conditional_experiments sbb sr_bns_address".split(" ").concat(ia(Rd)),
        oi = !1;
    ...
    function pi(a, b) {
        ...
        for (e in mi) {
            ...
            !f || !c && Rb(a) || d && void 0 !== b[e] || (b[e] = f)
        }
        "X-Goog-EOM-Visitor-Id" in b && "X-Goog-Visitor-Id" in b && delete b["X-Goog-Visitor-Id"];
        if (c || !Rb(a)) b["X-YouTube-Utc-Offset"] = String(-(new Date).getTimezoneOffset());
        if (c || !Rb(a)) {
            try {
        ...
        if (c ||
            !Rb(a)) b["X-YouTube-Ad-Signals"] = bi(ii());
        return b
    }
    ...
    function qi(a) {
        var b = window.location.search,
            c = Rb(a);
        N("debug_handle_relative_url_for_query_forward_killswitch") || c || !ei(a) || (c = document.location.hostname);
        var d = Qb(a.match(Pb)[5] || null);
        ...
        var d = ti(a, b),
            ...
            f = ui(a, function(k) {
                if (!e) {
                    ...
                    if (l || q || t) m = vi(a, c, k, b.convertToSafeHtml);
    ...
    function si(a, b) {
        ...
        if (b = b.urlParams) b[c] && delete b[c], a = di(a, b || {}, !0);
        return a
    }
    ...
    function ti(a, b) {
        ...
        b.excludeXsrf || Rb(a) && !b.withCredentials && Rb(a) != document.location.hostname || "POST" != b.method || h && "application/x-www-form-urlencoded" != h || b.postParams && b.postParams[g] || (f || (f = {}), f[c] = d);
        f && "string" === typeof e && (e = ci(e), qb(e, f), e = b.postBodyFormat && "JSON" == b.postBodyFormat ? JSON.stringify(e) : Ub(e));
        if (!(a = e) && (a = f)) {
            a: {
                for (var k in f) {
                    f = !1;
            ...
            a = !f
        }!oi && a && "POST" != b.method && (oi = !0, Lh(Error("AJAX request with postData should use POST")));
        return e
    }
        ...
        switch (b) {
            case "JSON":
                try {
                    ...
                    throw d = Error("Error reading responseText"), d.params = a, Mh(d), g;
                }
                a = c.getResponseHeader("Content-Type") || "";
                f && 0 <= a.indexOf("json") && (")]}'\n" === f.substring(0, 5) && (f = f.substring(5)), e = JSON.parse(f));
                break;
            case "XML":
                if (a = (a = c.responseXML) ? wi(a) : null) e = {}, D(a.getElementsByTagName("*"), function(g) {
                    e[g.tagName] = xi(g)
                })
        }
        d && yi(e);
    ...
    function ui(a, b, c, d, e, f, g) {
        function h() {
            4 == (k && "readyState" in k ? k.readyState : 0) && b && Kh(b)(k)
        }
        c = void 0 === c ? "GET" : c;
        d = void 0 === d ? "" : d;
        var k = li();
        ...
        N("debug_forward_web_query_parameters") && (a = qi(a));
        k.open(c, a, !0);
        f && (k.responseType = f);
    ...
    var zi = {
        Qb: "WEB_DISPLAY_MODE_UNKNOWN",
        Mb: "WEB_DISPLAY_MODE_BROWSER",
        Ob: "WEB_DISPLAY_MODE_MINIMAL_UI",
        Pb: "WEB_DISPLAY_MODE_STANDALONE",
        Nb: "WEB_DISPLAY_MODE_FULLSCREEN"
    };
    ...
    function Gi() {
        return "INNERTUBE_API_KEY" in Eh && "INNERTUBE_API_VERSION" in Eh
    }
    ...
    function Hi() {
        return {
            ...
            Ca: L("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),
            Sa: L("INNERTUBE_CONTEXT_CLIENT_NAME", "WEB"),
            rb: L("INNERTUBE_CONTEXT_CLIENT_NAME", 1),
            innertubeContextClientVersion: L("INNERTUBE_CONTEXT_CLIENT_VERSION"),
            Ua: L("INNERTUBE_CONTEXT_HL"),
            Ta: L("INNERTUBE_CONTEXT_GL"),
            sb: L("INNERTUBE_HOST_OVERRIDE") || "",
            ub: !!L("INNERTUBE_USE_THIRD_PARTY_AUTH", !1),
            tb: !!L("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT", !1),
    ...
    function Ii(a) {
        ...
        Li(a, void 0, b);
        Mi(void 0, b);
        L("DELEGATED_SESSION_ID") && !N("pageid_as_header_web") &&
            (b.user = {
                onBehalfOfUser: L("DELEGATED_SESSION_ID")
            });
        a = Object;
        c = a.assign;
        for (var d = b.client, e = {}, f = u(Object.entries(ci(L("DEVICE", "")))), g = f.next(); !g.done; g = f.next()) {
            var h = u(g.value);
            g = h.next().value;
            h = h.next().value;
    ...
    function Ni(a) {
        ...
        Li(a, c);
        Mi(c);
        L("DELEGATED_SESSION_ID") && !N("pageid_as_header_web") && (a = new ch, F(a, 3, L("DELEGATED_SESSION_ID")));
        a = u(Object.entries(ci(L("DEVICE", ""))));
        for (d = a.next(); !d.done; d = a.next()) e = u(d.value), d = e.next().value, e = e.next().value, "cbrand" === d ? F(c, 12, e) : "cmodel" === d ? F(c, 13, e) : "cbr" === d ? F(c, 87, e) : "cbrver" === d ? F(c, 88, e) : "cos" === d ? F(c, 18, e) : "cosver" === d ? F(c, 19, e) : "cplatform" === d && F(c, 42, e);
        H(b, Yg, 1, c);
        return b
    }
    ...
    function Ji(a, b, c) {
        ...
        if ("WEB" === a || "MWEB" === a || 1 === a || 2 === a)
            if (b) {
                c = id(b, Vg, 96) || new Vg;
                var d = Ai();
                d = Object.keys(zi).indexOf(d);
                d = -1 === d ? null : d;
                null !== d && F(c, 3, d);
                H(b, Vg, 96, c)
            } else c && (c.client.mainAppWebInfo = null != (d = c.client.mainAppWebInfo) ? d : {}, c.client.mainAppWebInfo.webDisplayMode = Ai())
    }

    function Ki(a, b) {
        var c;
        if (N("web_log_memory_total_kbytes") && (null == (c = A.navigator) ? 0 : c.deviceMemory)) {
            var d;
    ...
    function Mi(a, b) {
        a: {
            var c = Fi();
            if (c) {
                var d = Bi[c.type || "unknown"] || "CONN_UNKNOWN";
                c = Bi[c.effectiveType || "unknown"] || "CONN_UNKNOWN";
        ...
        d && (a ? F(a, 61, Ci[d]) : b && (b.client.connectionType = d));N("web_log_effective_connection_type") && (d = Fi(), d = null != d && d.effectiveType ? Ei.hasOwnProperty(d.effectiveType) ? Ei[d.effectiveType] : "EFFECTIVE_CONNECTION_TYPE_UNKNOWN" : void 0, d && (a ? F(a, 94, Di[d]) :
    ...
    function Oi(a, b, c) {
        ...
        (b = c.Sb || L("AUTHORIZATION")) || (a ? b = "Bearer " + B("gapi.auth.getToken")().Rb : b = ce([]));
    ...
    function Qi(a) {
        var b = new Lg;
        (b = b.isAvailable() ? a ? new Rg(b, a) : b : null) || (a = new Mg(a || "UserDataSharedStore"), b = a.isAvailable() ? a : null);
        this.i = (a = b) ? new Hg(a) : null;
        this.j = document.domain || window.location.hostname
    }
    Qi.prototype.set = function(a, b, c, d) {
        c = c || 31104E3;
        this.remove(a);
        if (this.i) try {
    ...
    Qi.prototype.get = function(a, b) {
        ...
        if (d && (c = $d.get("" + a, void 0)) && (c = unescape(c), b)) try {
            c = JSON.parse(c)
        } catch (e) {
    ...
    Qi.prototype.remove = function(a) {
        ...
        var b = this.j;
        $d.remove("" + a, "/", void 0 === b ? "youtube.com" : b)
    };
    var Ri = window,
        P = Ri.ytcsi && Ri.ytcsi.now ? Ri.ytcsi.now : Ri.performance && Ri.performance.timing && Ri.performance.now && Ri.performance.timing.navigationStart ? function() {
            return Ri.performance.timing.navigationStart + Ri.performance.now()
        } : function() {
    ...
    function Ui(a, b, c, d) {
        ...
        Ti().set("nextId", d + 1, 86400, !0);
        Ti().set("requests", e, 86400, !0);
        return d
    }

    function Vi(a) {
        var b = Ti().get("requests", !0) || {};
        delete b[a];
        Ti().set("requests", b, 86400, !0)
    }
        ...
        if (b) {
            for (var c in b) {
                ...
                if (!(6E4 > Math.round(P()) - d.requestTime)) {
                    var e = d.authState,
                        f = Pi(Oi(!1));
                    lb(e, f) && (e = d.request, "requestTimeMs" in e && (e.requestTimeMs = Math.round(P())), Xi(a, d.method, e, {}));
                    delete b[c]
                }
            }
            Ti().set("requests", b, 86400, !0)
    ...
    function Zi(a, b, c) {
        ...
        return d ? d(a, b, c) : void 0 === c ? (a(), NaN) : Vh(a, c || 0)
    }
    aj.prototype.Z = function(a) {
    ...
    var oj = {},
        pj = (oj.AUTH_INVALID = "No user identifier specified.", oj.EXPLICIT_ABORT = "Transaction was explicitly aborted.", oj.IDB_NOT_SUPPORTED = "IndexedDB is not supported.", oj.MISSING_INDEX = "Index not created.", oj.MISSING_OBJECT_STORES = "Object stores not created.", oj.DB_DELETED_BY_MISSING_OBJECT_STORES = "Database is deleted because expected object stores were not created.", oj.DB_REOPENED_BY_MISSING_OBJECT_STORES = "Database is reopened because expected object stores were not created.", oj.UNKNOWN_ABORT = "Transaction was aborted for unknown reasons.",
            oj.QUOTA_EXCEEDED = "The current transaction exceeded its quota limitations.", oj.QUOTA_MAYBE_EXCEEDED = "The current transaction may have failed because of exceeding quota limitations.", oj.EXECUTE_TRANSACTION_ON_CLOSED_DB = "Can't start a transaction on a closed database", oj.INCOMPATIBLE_DB_VERSION = "The binary is incompatible with the database version", oj),
        qj = {},
        rj = (qj.AUTH_INVALID = "ERROR", qj.EXECUTE_TRANSACTION_ON_CLOSED_DB = "WARNING", qj.EXPLICIT_ABORT = "IGNORED", qj.IDB_NOT_SUPPORTED = "ERROR", qj.MISSING_INDEX =
            "WARNING", qj.MISSING_OBJECT_STORES = "ERROR", qj.DB_DELETED_BY_MISSING_OBJECT_STORES = "WARNING", qj.DB_REOPENED_BY_MISSING_OBJECT_STORES = "WARNING", qj.QUOTA_EXCEEDED = "WARNING", qj.QUOTA_MAYBE_EXCEEDED = "WARNING", qj.UNKNOWN_ABORT = "WARNING", qj.INCOMPATIBLE_DB_VERSION = "WARNING", qj),
        sj = {},
        tj = (sj.AUTH_INVALID = !1, sj.EXECUTE_TRANSACTION_ON_CLOSED_DB = !1, sj.EXPLICIT_ABORT = !1, sj.IDB_NOT_SUPPORTED = !1, sj.MISSING_INDEX = !1, sj.MISSING_OBJECT_STORES = !1, sj.DB_DELETED_BY_MISSING_OBJECT_STORES = !1, sj.DB_REOPENED_BY_MISSING_OBJECT_STORES = !1, sj.QUOTA_EXCEEDED = !1, sj.QUOTA_MAYBE_EXCEEDED = !0, sj.UNKNOWN_ABORT = !0, sj.INCOMPATIBLE_DB_VERSION = !1, sj);
    ...
    function uj(a, b) {
        R.call(this, "MISSING_OBJECT_STORES", {
    ...
    function xj(a, b, c, d) {
        ...
        if (uc && "UnknownError" === e.name) return new R("QUOTA_MAYBE_EXCEEDED", a);
        if (e instanceof vj) return new R("MISSING_INDEX", Object.assign({}, a, {
    ...
    T.all = function(a) {
        return new T(new Bj(function(b, c) {
            var d = [],
                e = a.length;
            0 === e && b(d);
            for (var f = {
                    ...
                    Y: f.Y
                }, ++f.Y) Cj(T.resolve(a[f.Y]).then(function(g) {
                return function(h) {
                    d[g.Y] = h;
                    e--;
                    0 === e && b(d)
    ...
    T.prototype.then = function(a, b) {
        var c = this,
            d = null != a ? a : Aj,
            e = null != b ? b : zj;
        return new T(new Bj(function(f, g) {
    ...
    function Dj(a, b, c, d, e) {
        try {
            ...
            f instanceof T ? Fj(a, b, f, d, e) : d(f)
        } catch (g) {
            e(g)
        }
    }
    ...
    function Ij(a, b) {
        return new T(new Bj(function(c, d) {
            function e() {
                var f = a ? b(a) : null;
                f ? f.then(function(g) {
                    a = g;
        ...
        return x(function(G) {
            switch (G.i) {
                ...
                case 2:
                    ...
                    return w(G, K, 6);
                case 6:
                    return m = G.j, q = Math.round(P()), Ek(a, k, q, g, void 0, b.join(), e), G.return(m);
                case 4:
                    t = za(G);
                    p = Math.round(P());
                    y = xj(t, a.i.name, b.join(), a.i.version);
                    if ((z = y instanceof R && !y.i) || g >= f) Ek(a, k, p, g, y, b.join(), e), h = y;
                    G.u(2);
                    break;
                case 3:
    ...
    function Ek(a, b, c, d, e, f, g) {
        b = c - b;
        e ? (e instanceof R && ("QUOTA_EXCEEDED" === e.type || "QUOTA_MAYBE_EXCEEDED" === e.type) && ij("QUOTA_EXCEEDED", {
            dbName: nj(a.i.name),
            objectStoreNames: f,
            transactionCount: a.transactionCount,
            transactionMode: g.mode
        }), e instanceof R && "UNKNOWN_ABORT" === e.type && (c -= a.l, 0 > c && c >= Math.pow(2, 31) && (c = 0), ij("TRANSACTION_UNEXPECTEDLY_ABORTED", {
            objectStoreNames: f,
            transactionDuration: b,
            transactionCount: a.transactionCount,
            dbDuration: c
        }), a.j = !0), Fk(a, !1, d, f, b, g.tag), hj(e)) : Fk(a, !0, d, f, b, g.tag)
    }
    ...
    n = Mj.prototype;
    n.add = function(a, b) {
        return U(this.i.add(a, b))
    };
    n.autoIncrement = function() {
        return this.i.autoIncrement
    };
    n.clear = function() {
        return U(this.i.clear()).then(function() {})
    };
    n.count = function(a) {
        return U(this.i.count(a))
    };
    ...
    n.delete = function(a) {
        return a instanceof IDBKeyRange ? Gk(this, a) : U(this.i.delete(a))
    };
    n.get = function(a) {
        return U(this.i.get(a))
    };
    n.index = function(a) {
        try {
            return new Ik(this.i.index(a))
        } catch (b) {
            if (b instanceof Error && "NotFoundError" === b.name) throw new vj(a, this.i.name);
            throw b;
        }
    };
    n.getName = function() {
    ...
    function Ok(a, b) {
        ...
        var c, d, e, f;
        return x(function(g) {
            if (1 == g.i) return xa(g, 2), c = self.indexedDB.deleteDatabase(a), d = b, (e = d.blocked) && c.addEventListener("blocked", function() {
                e()
            }), w(g, Hj(c), 4);
            if (2 != g.i) return ya(g, 0);
            f = za(g);
            throw xj(f, a, "", -1);
        })
    };
    ...
    function Sk(a, b) {
        if (!b) throw yj("openWithToken", nj(a.name));
        return Tk(a)
    }
    ...
    function Tk(a) {
        function b() {
            ...
            return x(function(z) {
                switch (z.i) {
                    case 1:
                        return g = null != (f = Error().stack) ? f : "", xa(z, 2), w(z, a.l(a.name, a.options.version, d), 4);
                    case 4:
                        h = z.j;
                        for (var G = a.options, K = [], M = u(Object.keys(G.ja)), O = M.next(); !O.done; O = M.next()) {
                            O = O.value;
                            var nb = G.ja[O],
                                Ac = void 0 === nb.xb ? Number.MAX_VALUE : nb.xb;
                            !(h.i.version >= nb.Aa) || h.i.version >= Ac || h.i.objectStoreNames.contains(O) || K.push(O)
                        }
                        k = K;
                        if (0 === k.length) {
                            z.u(5);
                        ...
                        if (a.s < gi("ytidb_reopen_db_retries", 0)) return a.s++, h.close(), hj(new R("DB_REOPENED_BY_MISSING_OBJECT_STORES", {
                            dbName: a.name,
                            expectedObjectStores: l,
                            foundObjectStores: m
                        })), z.return(b());
                        if (!(a.o < gi("ytidb_remake_db_retries", 1))) {
                            z.u(6);
                            break
                        }
                        a.o++;
                    ...
                    case 9:
                        return hj(new R("DB_DELETED_BY_MISSING_OBJECT_STORES", {
                            dbName: a.name,
                            expectedObjectStores: l,
                            foundObjectStores: m
                        })), z.return(b());
                    ...
                    case 11:
                        t = z.j;
                        p = t.i.version;
                        if (void 0 !== a.options.version && p > a.options.version + 1) throw t.close(),
                            a.m = !1, Rk(a, p);
                        return z.return(t);
                    case 10:
                        throw c(), q instanceof Error && !N("ytidb_async_stack_killswitch") && (q.stack = q.stack + "\n" + g.substring(g.indexOf("\n") + 1)), xj(q, a.name, "", null != (y = a.options.version) ? y : -1);
                }
            })
        }
        ...
        return x(function(d) {
            ...
            return d.return(Kj(c, ["databases"], {
                ...
                return f.get(a.actualName).then(function(g) {
                    if (g ? a.actualName !== g.actualName || a.publicName !== g.publicName || a.userIdentifier !== g.userIdentifier : 1) return U(f.i.put(a, void 0)).then(function() {})
                })
            }))
        })
    }
    ...
    function Wk(a, b) {
        var c;
        return x(function(d) {
            if (1 == d.i) return a ? w(d, Sk(Uk, b), 2) : d.return();
            c = d.j;
    ...
    function Xk(a, b) {
        var c, d;
        return x(function(e) {
            return 1 == e.i ? (c = [], w(e, Sk(Uk, b), 2)) : 3 != e.i ? (d = e.j, w(e, Kj(d, ["databases"], {
                I: !0,
                mode: "readonly"
            }, function(f) {
                c.length = 0;
        ...
        return x(function(e) {
            switch (e.i) {
                case 1:
                    ...
                    var f;
                    if (f = cj) f = /WebKit\/([0-9]+)/.exec(Lb()), f = !!(f && 600 <= parseInt(f[1], 10));
                    f && (f = /WebKit\/([0-9]+)/.exec(Lb()), f = !(f && 602 <= parseInt(f[1], 10)));
                    if (f || gc) return e.return(!1);
                    try {
    ...
    function el(a) {
        if (!kj()) throw a = new R("AUTH_INVALID", {
            dbName: a
        }), hj(a), a;
        var b = lj();
        return {
    ...
    function fl(a, b, c, d) {
        ...
        return x(function(m) {
            switch (m.i) {
                case 1:
                    return f = null != (e = Error().stack) ? e : "", w(m, dl(), 2);
                case 2:
                    g = m.j;
                    if (!g) throw h = yj("openDbImpl", a, b), N("ytidb_async_stack_killswitch") || (h.stack = h.stack + "\n" + f.substring(f.indexOf("\n") + 1)), hj(h), h;
                    mj(a);
                    k = c ? {
                        actualName: a,
                        publicName: a,
                ...
                case 6:
                    return m.return(m.j);
                case 3:
                    return l = za(m), xa(m, 7), w(m, Wk(k.actualName, g), 9);
                case 9:
                    ya(m,
                        8);
                    break;
    ...
    function ml(a) {
        ...
        this.ga = !1;
        var b;
        this.cb = null != (b = a.cb) ? b : 100;
        var c;
        this.bb = null != (c = a.bb) ? c : 1;
        var d;
        this.Za = null != (d = a.Za) ? d : 2592E6;
        var e;
        this.Ya = null != (e = a.Ya) ? e : 12E4;
        var f;
        this.ab = null != (f = a.ab) ? f : 5E3;
        var g;
        this.A = null != (g = a.A) ? g : void 0;
        this.ta = !!a.ta;
        var h;
        this.sa = null != (h = a.sa) ? h : .1;
        var k;
        this.xa = null != (k = a.xa) ? k : 10;
    ...
    function ol(a) {
        nl(a) && !a.ga && (a.i = !0, a.ta && Math.random() <= a.sa && a.D.lb(a.A), pl(a), a.G.F() && a.na(), a.G.X(a.Ga, a.na.bind(a)), a.G.X(a.Fa, a.Ma.bind(a)))
    }
    n = ml.prototype;
    n.writeThenSend = function(a, b) {
        ...
        if (nl(this) && this.i) {
            ...
            this.D.set(d, this.A).then(function(e) {
                d.id = e;
                c.G.F() && ql(c, d)
            }).catch(function(e) {
                ql(c, d);
            ...
            if (this.G.F() || this.B && this.B("nwl_aggressive_send_then_write") && !e.skipRetry) {
                if (!e.skipRetry) {
                    ...
                    b.onError = function(g, h) {
                        return x(function(k) {
                            if (1 == k.i) return w(k, d.D.set(e, d.A).catch(function(l) {
                                rl(d, l)
                            }), 2);
                            f(g, h);
                            k.i = 0
                ...
                this.R(a, b, e.skipRetry)
            } else this.D.set(e, this.A).catch(function(g) {
                d.R(a, b, e.skipRetry);
                rl(d, g)
            })
        } else this.R(a, b, this.B && this.B("nwl_skip_retry") && c)
    };
    n.sendAndWrite = function(a, b) {
        ...
        if (nl(this) && this.i) {
            ...
            d.options.onSuccess = function(g, h) {
                void 0 !== d.id ? c.D.aa(d.id, c.A) : e = !0;
                c.G.P && c.B && c.B("vss_network_hint") && c.G.P(!0);
                f(g, h)
            };
            this.R(d.url, d.options);
            this.D.set(d, this.A).then(function(g) {
                d.id = g;
                e && c.D.aa(d.id, c.A)
            }).catch(function(g) {
                rl(c, g)
    ...
    n.na = function() {
        var a = this;
        if (!nl(this)) throw yj("throttleSend");
        this.j || (this.j = this.K.O(function() {
            var b;
            return x(function(c) {
                if (1 == c.i) return w(c, a.D.Qa("NEW", a.A), 2);
                if (3 != c.i) return b = c.j, b ? w(c, ql(a, b), 3) : (a.Ma(), c.return());
                a.j && (a.j = 0, a.na());
                c.i = 0
            })
        }, this.cb))
    ...
    function ql(a, b) {
        ...
        return x(function(e) {
            switch (e.i) {
                case 1:
                    if (!nl(a)) throw c = yj("immediateSend"), c;
                    if (void 0 === b.id) {
                        e.u(2);
                        break
                    }
                    return w(e, a.D.wb(b.id, a.A), 3);
                case 3:
                    (d = e.j) ? b = d: a.ca(Error("The request cannot be found in the database."));
                case 2:
                    if (sl(a, b, a.Za)) {
                        e.u(4);
                        break
                    }
                    a.ca(Error("Networkless Logging: Stored logs request expired age limit"));
                    if (void 0 === b.id) {
                        e.u(5);
                        break
                    }
                    return w(e, a.D.aa(b.id, a.A), 5);
                case 5:
                    return e.return();
                case 4:
                    ...
                    return w(e, a.D.aa(b.id, a.A), 8);
                case 8:
                    a.R(b.url, b.options, !!b.skipRetry), e.i = 0
            }
        })
    }

    function tl(a, b) {
        if (!nl(a)) throw yj("updateRequestHandlers");
        ...
        b.options.onError = function(e, f) {
            ...
            return x(function(l) {
                switch (l.i) {
                    case 1:
                        g = ul(f);
                        if (!(a.B && a.B("nwl_consider_error_code") && g || a.B && !a.B("nwl_consider_error_code") && a.potentialEsfErrorCounter <= a.xa)) {
                            l.u(2);
                            break
                        }
                        if (!a.G.la) {
                    ...
                    case 3:
                        ...
                        return w(l, a.D.Ha(b.id, a.A, !1), 6);
                    case 6:
                        return l.return();
                    case 2:
                        if (a.B && a.B("nwl_consider_error_code") &&
                            !g && a.potentialEsfErrorCounter > a.xa) return l.return();
                        a.potentialEsfErrorCounter++;
                        if (void 0 === (null == (k = b) ? void 0 : k.id)) {
                            l.u(8);
                            break
                        }
                        return b.sendCount < a.bb ? w(l, a.D.Ha(b.id, a.A), 12) : w(l, a.D.aa(b.id, a.A), 8);
                    case 12:
                        a.K.O(function() {
                            a.G.F() && a.na()
                        }, a.ab);
        ...
        b.options.onSuccess = function(e, f) {
            var g;
            return x(function(h) {
                if (1 == h.i) return void 0 === (null == (g = b) ? void 0 : g.id) ? h.u(2) : w(h, a.D.aa(b.id, a.A), 2);
    ...
    function pl(a) {
        if (!nl(a)) throw yj("retryQueuedRequests");
        a.D.Qa("QUEUED", a.A).then(function(b) {
            b && !sl(a, b, a.Ya) ? a.K.O(function() {
                return x(function(c) {
                    if (1 == c.i) return void 0 === b.id ? c.u(2) : w(c, a.D.Ha(b.id, a.A), 2);
                    pl(a);
                    c.i = 0
                })
            }) : a.G.F() && a.na()
    ...
    function rl(a, b) {
        a.eb && !a.G.F() ? a.eb(b) : a.handleError(b)
    }
    ...
    var vl = B("ytPubsub2Pubsub2Instance") || new J;
    J.prototype.subscribe = J.prototype.subscribe;
    J.prototype.unsubscribeByKey = J.prototype.oa;
    J.prototype.publish = J.prototype.da;
    ...
    wl.prototype.l = function(a, b, c) {
        c = void 0 === c ? {} : c;
        return (this.options.Ia ? hl : gl)(a, b, Object.assign({}, c))
    };
    wl.prototype.delete = function(a) {
        a = void 0 === a ? {} : a;
        return (this.options.Ia ? ll : il)(this.name, a)
    };
    ...
    function El(a, b) {
        ...
        return x(function(l) {
            ...
            if (3 != l.i) return d = l.j, e = L("INNERTUBE_CONTEXT_CLIENT_NAME", 0), f = [a, e, 0], g = [a, e, P()], h = IDBKeyRange.bound(f, g), k = void 0, w(l, Kj(d, ["LogsRequestsStore"], {
                    mode: "readwrite",
                    I: !0
                }, function(m) {
                    return Kk(m.objectStore("LogsRequestsStore").index("newRequestV2"), {
                        ...
                        q.T() && (k = q.T(), "NEW" === a && (k.status = "QUEUED", q.update(k)))
                    })
                }),
                3);
            c.Ab = P();
        ...
        return x(function(d) {
            ...
            return d.return(Kj(c, ["LogsRequestsStore"], {
                ...
                return f.get(a).then(function(g) {
                    if (g) return g.status = "QUEUED", U(f.i.put(g, void 0)).then(function() {
                        return g
                    })
                })
            }))
        ...
        return x(function(e) {
            ...
            return e.return(Kj(d, ["LogsRequestsStore"], {
                ...
                return g.get(a).then(function(h) {
                    return h ? (h.status = "NEW", c && (h.sendCount += 1), U(g.i.put(h, void 0)).then(function() {
                        return h
                    })) : T.resolve(void 0)
                })
            }))
    ...
    function Dl(a) {
        if (!N("nwl_csi_killswitch") && .01 >= Math.random()) {
    ...
    function Rl(a) {
        ...
        var c = void 0 === c ? !1 : c;
        if (a)
            if (b) ui(a, void 0, "POST", b);
            else if (L("USE_NET_AJAX_FOR_PING_TRANSPORT", !1)) ui(a, void 0, "GET", "", void 0, void 0, c);
        else {
            b: {
                try {
                    var d = new Za({
                    ...
                    if (d.l && d.j || d.m) {
                        var e = Qb(a.match(Pb)[5] || null);
                        var f = !(!e || !e.endsWith("/aclk") || "1" !== Wb(a, "ri"));
                        break b
                    }
                } catch (h) {}
                f = !1
    ...
    function Tl() {
        if (!V.i) {
            var a = B("yt.networkRequestMonitor.instance") || new V;
    ...
    function Y() {
        ...
        this.m = !1;
        this.j = Ne();
        this.j.X("networkstatus-online", function() {
            if (a.m && N("offline_error_handling")) {
                var b = Vl().get("errors", !0);
                if (b) {
                    for (var c in b)
                        if (b[c]) {
                            var d = new jj(c, "sent via offline_errors");
                            d.name = b[c].name;
                            d.stack = b[c].stack;
                            d.level = b[c].level;
                            Lh(d)
    ...
    n.la = function(a) {
        a = Le(this.j, a);
        a.then(function(b) {
            N("use_cfr_monitor") && Tl().requestComplete("generate_204", b)
        });
        return a
    };
    Y.prototype.sendNetworkCheckRequest = Y.prototype.la;
    Y.prototype.listen = Y.prototype.X;
    Y.prototype.enableErrorFlushing = Y.prototype.nb;
    Y.prototype.getWindowStatus = Y.prototype.qb;
    Y.prototype.networkStatusHint = Y.prototype.P;
    Y.prototype.isNetworkAvailable = Y.prototype.F;
    Y.getInstance = Xl;
    ...
    function Yl(a) {
        ...
        this.j = this.v = 0;
        this.m = Xl();
        var c = B("yt.networkStatusManager.instance.listen").bind(this.m);
        c && (a.ya ? (this.ya = a.ya, c("networkstatus-online", function() {
            Zl(b, "publicytnetworkstatus-online")
        }), c("networkstatus-offline", function() {
            Zl(b, "publicytnetworkstatus-offline")
    ...
    Yl.prototype.F = function() {
        ...
        return a ? a.bind(this.m)() : !0
    };
    Yl.prototype.P = function(a) {
        var b = B("yt.networkStatusManager.instance.networkStatusHint").bind(this.m);
        b && b(a)
    };
    Yl.prototype.la = function(a) {
        var b = this,
            c;
        return x(function(d) {
            c = B("yt.networkStatusManager.instance.sendNetworkCheckRequest").bind(b.m);
            return N("skip_network_check_if_cfr") && Tl().isEndpointCFR("generate_204") ? d.return(new Promise(function(e) {
                var f;
                b.P((null == (f = window.navigator) ? void 0 : f.onLine) || !0);
                e(b.F())
    ...
    function Zl(a, b) {
        a.ya ? a.j ? (Oe.Z(a.v), a.v = Oe.O(function() {
            a.s !== b && (Ie(a, b), a.s = b, a.j = P())
        }, a.ya - (P() - a.j))) : (Ie(a, b), a.s = b, a.j = P()) : Ie(a, b)
    };
    var $l;
    ...
    function am() {
        ml.call(this, {
            ...
            eb: Wl,
            K: bj(),
            Ga: "publicytnetworkstatus-online",
            Fa: "publicytnetworkstatus-offline",
            ta: !0,
            sa: .1,
            xa: gi("potential_esf_error_limit", 10),
            B: N,
            ga: !(kj() && "www.youtube-nocookie.com" !== Rb(document.location.toString()))
        });
        this.l = new Nf;
        N("networkless_immediately_drop_all_requests") && Jl();
        ll("LogsDatabaseV2")
    }
    v(am, ml);
    ...
    function dm() {
        ...
        a || (a = new am, C("yt.networklessRequestController.instance", a), N("networkless_logging") && dl().then(function(b) {
            a.A = b;
            ol(a);
            a.l.resolve();
            a.ta && Math.random() <= a.sa && a.A && Nl(a.A);
            N("networkless_immediately_drop_sw_health_store") && em(a)
        }));
        return a
    }
    am.prototype.writeThenSend = function(a, b) {
        b || (b = {});
        kj() || (this.i = !1);
        ml.prototype.writeThenSend.call(this, a, b)
    };
    am.prototype.sendThenWrite = function(a, b, c) {
        b || (b = {});
        kj() || (this.i = !1);
        ml.prototype.sendThenWrite.call(this, a, b, c)
    };
    am.prototype.sendAndWrite = function(a, b) {
        b || (b = {});
        kj() || (this.i = !1);
        ml.prototype.sendAndWrite.call(this, a, b)
    };
    am.prototype.awaitInitialization = function() {
    ...
    function em(a) {
        var b;
        x(function(c) {
            if (!a.A) throw b = yj("clearSWHealthLogsDb"), b;
    ...
    function cm(a, b, c) {
        N("use_cfr_monitor") && fm(a, b);
        if (N("use_request_time_ms_header")) b.headers && (b.headers["X-Goog-Request-Time"] = JSON.stringify(Math.round(P())));
        else {
            var d;
            if (null == (d = b.postParams) ? 0 : d.requestTimeMs) b.postParams.requestTimeMs = Math.round(P())
        }
        c && 0 === Object.keys(b).length ? Rl(a) : ri(a, b)
    }
    ...
    var gm = 0,
        hm = 0,
        im, jm = A.ytNetworklessLoggingInitializationOptions || {
            isNwlInitialized: !1,
            potentialEsfErrorCounter: hm
        };
    C("ytNetworklessLoggingInitializationOptions", jm);

    function km(a, b) {
        function c(d) {
            var e = lm().F();
            if (!mm() || !d || e && N("vss_networkless_bypass_write")) nm(a, b);
            else {
                var f = {
                    url: a,
                    options: b,
        ...
        b = void 0 === b ? {} : b;
        N("skip_is_supported_killswitch") ? dl().then(function(d) {
            c(d)
        }) : c(cl())
    }
        ...
        function c(d) {
            if (mm() && d) {
                ...
                e.options.onSuccess = function(k, l) {
                    N("use_cfr_monitor") && Tl().requestComplete(e.url, !0);
                    void 0 !== e.id ? Hl(e.id, d) : f = !0;
                    N("vss_network_hint") && lm().P(!0);
                    g(k, l)
                };
    ...
    function qm() {
        var a = cl();
        if (!a) throw yj("throttleSend");
        gm || (gm = Oe.O(function() {
            var b;
            return x(function(c) {
                if (1 == c.i) return w(c, El("NEW", a), 2);
                if (3 != c.i) return b = c.j, b ? w(c, om(b), 3) : (Oe.Z(gm), gm = 0, c.return());
                gm && (gm = 0, qm());
                c.i = 0
            })
        }, 100))
    ...
    function om(a) {
        ...
        return x(function(e) {
            switch (e.i) {
                case 1:
                    b = cl();
                    if (!b) throw c = yj("immediateSend"), c;
                    if (void 0 === a.id) {
                        e.u(2);
                        break
                    }
                ...
                case 3:
                    (d = e.j) ? a = d: Mh(Error("The request cannot be found in the database."));
                case 2:
                    var f = a.timestamp;
                    if (!(2592E6 <= P() - f)) {
                        e.u(4);
                    ...
                    Mh(Error("Networkless Logging: Stored logs request expired age limit"));
                    if (void 0 === a.id) {
                        e.u(5);
                        break
                    }
                ...
                case 4:
                    a.skipRetry || (a = rm(a));
                    f = a;
                    if (N("use_request_time_ms_header")) {
                        var g;
                ...
                case 8:
                    nm(a.url, a.options, !!a.skipRetry), e.i = 0
            }
        })
    }
    ...
    function rm(a) {
        var b = cl();
        if (!b) throw yj("updateRequestHandlers");
        ...
        a.options.onError = function(e, f) {
            ...
            return x(function(l) {
                switch (l.i) {
                    case 1:
                        N("use_cfr_monitor") && Tl().requestComplete(a.url, !1);
                        g = ul(f);
                        if (!(N("nwl_consider_error_code") && g || !N("nwl_consider_error_code") && sm() <= gi("potential_esf_error_limit", 10))) {
                            l.u(2);
                            break
                        }
                        if (N("skip_checking_network_on_cfr_failure") && (!N("skip_checking_network_on_cfr_failure") || Tl().isEndpointCFR(a.url))) {
                            l.u(3);
                            break
                        }
                        return w(l, lm().la(), 3);
                    case 3:
                        ...
                        c(e, f);
                        if (!N("nwl_consider_error_code") || void 0 ===
                    ...
                    case 6:
                        return l.return();
                    case 2:
                        if (N("nwl_consider_error_code") && !g && sm() > gi("potential_esf_error_limit", 10)) return l.return();
                        B("ytNetworklessLoggingInitializationOptions") && jm.potentialEsfErrorCounter++;
                        hm++;
        ...
        a.options.onSuccess = function(e, f) {
            var g;
            return x(function(h) {
                if (1 == h.i) return N("use_cfr_monitor") && Tl().requestComplete(a.url, !0), void 0 === (null == (g = a) ? void 0 : g.id) ? h.u(2) : w(h, Hl(a.id, b), 2);
                N("vss_network_hint") && lm().P(!0);
                d(e, f);
                h.i = 0
            })
    ...
    function mm() {
        return B("ytNetworklessLoggingInitializationOptions") ? jm.isNwlInitialized : !1
    }

    function sm() {
        return B("ytNetworklessLoggingInitializationOptions") ? jm.potentialEsfErrorCounter : hm
    };
    ...
    function Xi(a, b, c, d) {
        function e(y) {
            y = void 0 === y ? !1 : y;
            var z;
            if (d.retry && "www.youtube-nocookie.com" != h && (y || N("skip_ls_gel_retry") || "application/json" !== g.headers["Content-Type"] || (z = Ui(b, c, l, k)), z)) {
                var G = g.onSuccess,
                    K = g.onFetchSuccess;
            ...
            try {
                y && d.retry && !d.Wa.bypassNetworkless ? (g.method = "POST", d.Wa.writeThenSend ? N("use_new_nwl_wts") ? dm().writeThenSend(p, g) : km(p, g) : N("use_new_nwl_saw") ? dm().sendAndWrite(p, g) : pm(p, g)) : (g.method = "POST", g.postParams || (g.postParams = {}), ri(p, g))
            } catch (M) {
                if ("InvalidAccessError" == M.name) z && (Vi(z), z = 0), Mh(Error("An extension is blocking network request."));
                else throw M;
            }
            z && Zi(function() {
                Wi(a)
            }, 0, 5E3)
        }!L("VISITOR_DATA") && "visitor_id" !== b && .01 > Math.random() && Mh(new jj("Missing VISITOR_DATA when sending innertube request.", b, c, d));
        if (!a.isReady()) {
        ...
        var p = di("" + h + m, q || {}, !0);
        N("use_new_nwl") && dm().i || !N("use_new_nwl") &&
            mm() ? bl().then(function(y) {
                e(y)
            }) : e(!1)
    };
    ...
    var vm = A.ytPubsubPubsubInstance || new J,
        wm = A.ytPubsubPubsubSubscribedKeys || {},
    ...
    J.prototype.publish = J.prototype.da;
    J.prototype.clear = J.prototype.clear;
    C("ytPubsubPubsubInstance", vm);
    C("ytPubsubPubsubTopicToKeys", xm);
    C("ytPubsubPubsubIsSynchronous", ym);
    C("ytPubsubPubsubSubscribedKeys", wm);
    ...
    zm.prototype.za = function(a, b) {
        ...
        b = [void 0 === a.auth ? "undefined" : a.auth, void 0 === a.isJspb ? "undefined" : a.isJspb, void 0 === a.isLeader ? "undefined" : a.isLeader, void 0 === a.cttAuthInfo ? "undefined" : a.cttAuthInfo].join("/");
        this.i[b] ? this.i[b]++ : this.i[b] = 1;
        this.i[b] >= this.policy.maxBatchSize && (this.policy.onBatchSizeExceeded(a), this.i[b] = 0);
        return b
    };
    zm.prototype.ba = function(a) {
        for (var b = [], c = [], d = u(this.store), e = d.next(); !e.done; e = d.next()) {
            e = e.value;
            a: {
                var f = a;
                var g = Object.keys(f);g = u(g);
            ...
            f ? b.push(e.payload) : c.push(e)
        }
        this.store = c;
        c = 0;
        a = Am(this, a);
        a = u(a);
        for (d = a.next(); !d.done; d = a.next()) d = d.value, c += this.i[d], this.i[d] = 0;
        c !== b.length && Mh(new jj("Transport IMS extracted entries count != keyCounter sum", b.length, c));
        return b
    };
    ...
    function Am(a, b) {
        var c = Object.keys(b),
            ...
            g = "THIS_KEY_FIELD_NOT_FILLED";
        c = u(c);
        for (var h = c.next(); !h.done; h = c.next()) h = h.value, "auth" === h ? d = Bm(b.auth) : "isJspb" === h ? e = JSON.stringify(b.isJspb) : "isLeader" === h ? f = JSON.stringify(b.isLeader) : "cttAuthInfo" === h && (g = Bm(b.cttAuthInfo));
        b = [];
        d = [d, e, f, g];
        a = u(Object.keys(a.i));
    ...
    zm.prototype.getSequenceCount = zm.prototype.Ra;
    zm.prototype.extractMatchingEntries = zm.prototype.ba;
    zm.prototype.storePayload = zm.prototype.za;

    function Bm(a) {
        return void 0 === a ? "undefined" : a
    };
    var Cm = A.window;
    Cm.ytExports || (Cm.ytExports = {
        logging: {
            transport: {
                leaderQueueLength: 0,
                leaderChosen: !1
    ...
    var Dm = gi("initial_gel_batch_timeout", 2E3),
        Em = Math.pow(2, 16) - 1,
        Fm = !1,
        Gm = void 0;
    ...
    var Im = new Hm,
        Jm = new Hm,
        Km = !0,
        Lm = A.ytLoggingTransportGELQueue_ || new Map;
    C("ytLoggingTransportGELQueue_", Lm);
    var Mm = new Map,
        Nm = A.ytLoggingTransportGELProtoQueue_ || new Map;
    C("ytLoggingTransportGELProtoQueue_", Nm);
    var Om = A.ytLoggingTransportTokensToCttTargetIds_ || {};
    C("ytLoggingTransportTokensToCttTargetIds_", Om);
    var Pm = A.ytLoggingTransportTokensToJspbCttTargetIds_ || {};
    C("ytLoggingTransportTokensToJspbCttTargetIds_", Pm);
    var Qm = {};

    function Rm() {
        var a = B("yt.logging.ims");
        a || (a = new zm({
            maxBatchSize: gi("tvhtml5_logging_max_batch") || gi("web_logging_max_batch") || 100,
            onBatchSizeExceeded: function(b) {
                Sm({
                    writeThenSend: !0
                }, void 0, b.isJspb)
            }
    ...
    function Tm() {
        N("jspb_with_transport_leader") && !Cm.ytExports.logging.transport.leaderChosen && (Fm = Cm.ytExports.logging.transport.leaderChosen = !0, document.addEventListener("FLUSH_REQUEST", function() {
            Sm(void 0, void 0, !0)
        }))
    }
    ...
    function Um(a, b) {
        ...
        if ("log_event" === a.endpoint) {
            ...
            if (N("use_new_in_memory_storage")) {
                ...
                Rm().za(d, a.payload);
                Xm(b, [], c, !1, d)
            } else d = Lm.get(c) || [], Lm.set(c, d), d.push(a.payload), Xm(b, d, c)
        }
    }
    ...
    function Ym(a, b) {
        ...
        if ("log_event" === a.endpoint) {
            Vm(void 0, a);
            var c = Wm(a, !0);
            if (N("jspb_with_transport_leader") && Fm)
                if (N("use_new_in_memory_storage")) {
                    Qm[c] = !0;
                    var d = {
                        cttAuthInfo: c,
                    ...
                    Rm().za(d, a.payload);
                    Cm.ytExports.logging.transport.leaderQueueLength++;
                    Xm(b, [], c, !0, d)
                } else d = Mm.get(c) || [], Mm.set(c, d), Cm.ytExports.logging.transport.leaderQueueLength++, d.push(a.payload), Xm(b, d, c, !0);
            else N("use_new_in_memory_storage") ? (Qm[c] = !0, d = {
                cttAuthInfo: c,
                isJspb: !0,
                isLeader: Fm
            }, Rm().za(d,
                a.payload.toJSON()), Xm(b, [], c, !0, d)) : (d = Nm.get(c) || [], Nm.set(c, d), a = a.payload.toJSON(), d.push(a), Xm(b, d, c, !0))
        }
    }
    ...
    function Xm(a, b, c, d, e) {
        d = void 0 === d ? !1 : d;
        a && (Gm = new a);
        a = gi("tvhtml5_logging_max_batch") || gi("web_logging_max_batch") || 100;
        var f = P(),
            g = d ? Jm.l : Im.l,
            h = Nm.get(c) || [];
        b = b.length;
        e && (e = mb(e), delete e.isLeader, b = Rm().Ra(e));
        N("jspb_with_transport_leader") && (Fm && b + h.length >= a || !Fm && Cm.ytExports.logging.transport.leaderQueueLength + b >= a) || b >= a ? Sm({
            writeThenSend: !0
        }, N("flush_only_full_queue") ? c : void 0, d) : 10 <= f - g && (Zm(d), d ? Jm.l = f : Im.l = f)
    }
    ...
    function $m(a, b) {
        ...
        if ("log_event" === a.endpoint) {
            ...
            d.set(c, [a.payload]);
            b && (Gm = new b);
            return new Of(function(e, f) {
                Gm && Gm.isReady() ? an(d, Gm, e, f, {
                    bypassNetworkless: !0
                }, !0) : e()
            })
        }
    ...
    function bn(a, b) {
        ...
        if ("log_event" === a.endpoint) {
            ...
            var c = Wm(a, !0),
                d = new Map,
                e = new Map;
            N("jspb_with_transport_leader") && Fm ? e.set(c, [a.payload]) : d.set(c, [a.payload.toJSON()]);
            b && (Gm = new b);
            return new Of(function(f) {
                Gm && Gm.isReady() ? cn(d, e, Gm, f, {
                    bypassNetworkless: !0
                }, !0) : f()
            })
        }
    ...
    function Wm(a, b) {
        ...
        if (a.fa) c = "visitorOnlyApprovedKey";
            ...
            if (void 0 === b ? 0 : b) {
                ...
                c = a.cttAuthInfo;
                var d = new xh;
                c.videoId ? d.setVideoId(c.videoId) : c.playlistId && gd(d, 2, yh, c.playlistId);
                Pm[b] = d
            } else b = a.cttAuthInfo, c = {}, b.videoId ? c.videoId = b.videoId : b.playlistId && (c.playlistId = b.playlistId), Om[a.cttAuthInfo.token] = c;
    ...
    function Sm(a, b, c) {
        ...
        c = void 0 === c ? !1 : c;
        new Of(function(d, e) {
            c ? (window.clearTimeout(Jm.j), window.clearTimeout(Jm.i), Jm.i = 0) : (window.clearTimeout(Im.j), window.clearTimeout(Im.i), Im.i = 0);
            if (N("jspb_with_transport_leader") && !Fm && c) document.dispatchEvent(new CustomEvent("FLUSH_REQUEST")), d();
            else if (Gm && Gm.isReady())
                if (N("use_new_in_memory_storage")) a: {
                    var f = a,
                        g = c,
                        h = Gm;f = void 0 === f ? {} : f;g = void 0 === g ? !1 : g;
                    var k = new Map,
                        l = new Map,
                        m = new Map;
                    if (void 0 !== b) {
                        if (g) {
                            ...
                            k.set(b, e);
                            if (N("jspb_with_transport_leader")) {
                                e = Rm().ba({
                                    isJspb: !0,
                                    cttAuthInfo: b,
                                    isLeader: !0
                                });
                                if (0 === e.length) break a;
                                l.set(b, e)
                            }
                            cn(k, l, h, d, f)
                        }
                        ...
                        e = u(Object.keys(Qm));
                        for (g = e.next(); !g.done; g = e.next()) m = g.value, g = Rm().ba({
                            isJspb: !0,
                            isLeader: !1,
                            cttAuthInfo: m
                        }), 0 < g.length && k.set(m, g), N("jspb_with_transport_leader") && (g = Rm().ba({
                            isJspb: !0,
                            isLeader: !0,
                            cttAuthInfo: m
                        }), 0 < g.length && l.set(m, g)), Qm[m] = !1;
                        cn(k, l, h, d, f)
                    } else {
                        k = u(Object.keys(Qm));
                        for (g = k.next(); !g.done; g = k.next()) l = g.value,
                            g = Rm().ba({
                                isJspb: !1,
                                cttAuthInfo: l
                            }), 0 !== g.length && m.set(l, g);
                        an(m, h, d, e, f)
                    }
                }
            else f = a, k = c, h = Gm, f = void 0 === f ? {} : f, k = void 0 === k ? !1 : k, void 0 !== b ? k ? (e = new Map, k = new Map, l = Nm.get(b) || [], e.set(b, l), N("jspb_with_transport_leader") && (l = Mm.get(b) || [], k.set(b, l)), cn(e, k, h, d, f), N("jspb_with_transport_leader") && Mm.delete(b), Nm.delete(b)) : (k = new Map, l = Lm.get(b) || [], k.set(b, l), an(k, h, d, e, f), Lm.delete(b)) : k ? (cn(Nm, Mm, h, d, f), Nm.clear(), N("jspb_with_transport_leader") && Mm.clear()) : (an(Lm, h, d, e, f), Lm.clear());
            else Zm(c),
                d()
        })
    }
    ...
    function Zm(a) {
        a = void 0 === a ? !1 : a;
        if (N("web_gel_timeout_cap") && (!a && !Im.i || a && !Jm.i)) {
            var b = Vh(function() {
                Sm({
                    writeThenSend: !0
                }, void 0, a)
        ...
        window.clearTimeout(a ? Jm.j : Im.j);
        b = L("LOGGING_BATCH_TIMEOUT", gi("web_gel_debounce_ms", 1E4));
        N("shorten_initial_gel_batch_timeout") && Km && (b = Dm);
        b = Vh(function() {
            Sm({
                writeThenSend: !0
            }, void 0, a)
    ...
    function an(a, b, c, d, e, f) {
        ...
        for (var k = a.next(); !k.done; k = a.next()) {
            ...
            if (!Ma(m) && !N("throw_err_when_logevent_malformed_killswitch")) {
                Lh(new jj("LogEvent value at event was not an array", m));
                d();
                break
            }
            k.events = m;
            ...
            try {
                Xi(b, "log_event", k, gn(e, l, m, q, f)), Km = !1
            } catch (t) {
                Lh(t), d()
            }
        }
    ...
    function cn(a, b, c, d, e, f) {
        ...
        for (var l = k.next(); !l.done; l = k.next()) {
            var m = u(l.value).next().value,
                ...
                t = b.get(m) || [];
            l = new zh;
            var p = Ni(c.config_ || Hi());
            H(l, eh, 1, p);
            q = q ? hn(q) : [];
            q = u(q);
            for (p = q.next(); !p.done; p = q.next()) md(l, 3, uh, p.value);
            t = u(t);
            for (q = t.next(); !q.done; q = t.next()) md(l, 3, uh, q.value);
            (t = Pm[m]) && jn(l, m, t);
            delete Pm[m];
            ...
            m = gn(e, m, function() {
                ...
                Cm.ytExports.logging.transport.leaderQueueLength = 0;
                h--;
                h || d()
            }, f);
    ...
    function gn(a, b, c, d, e) {
        ...
        N("use_request_time_ms_header") && (a.headers["X-Goog-Request-Time"] = JSON.stringify(Math.round(P())));
        return a
    }
    ...
    function en(a, b, c) {
        ...
        !c && (b = L("EVENT_ID")) && (c = ln(), a.serializedClientEventId = {
            serializedEventId: b,
    ...
    function ln() {
        ...
        a || (a = Math.floor(Math.random() * Em / 2));
        a++;
        a > Em && (a = 1);
        Fh("BATCH_CLIENT_COUNTER", a);
        return a
    }
    ...
    function hn(a) {
        for (var b = [], c = 0; c < a.length; c++) try {
            ...
            Lh(new jj("Transport failed to deserialize " + String(a[c])))
        }
        return b
    }
    ...
    function Vm(a, b) {
        if (B("yt.logging.transport.enableScrapingForTest")) {
            ...
            C("yt.logging.transport.scrapedPayloadsForTesting", c)
        }
    };
    var mn = A.ytLoggingGelSequenceIdObj_ || {};
    C("ytLoggingGelSequenceIdObj_", mn);
    ...
    function nn(a, b, c, d) {
        ...
        N("log_sequence_info_on_gel_web") && d.ma && (a = e.context, b = d.ma, b = {
            index: on(b),
            groupKey: b
        }, a.sequence = b, d.pb && delete mn[d.ma]);
        (d.yb ? $m : Um)({
            endpoint: "log_event",
            payload: e,
    ...
    function pn(a) {
        Sm(void 0, void 0, void 0 === a ? !1 : a)
    }

    function on(a) {
        mn[a] = a in mn ? mn[a] + 1 : 0;
        return mn[a]
    };
    var qn = A.ytLoggingGelSequenceIdObj_ || {};
    C("ytLoggingGelSequenceIdObj_", qn);
    ...
    function rn(a) {
        ...
        c = c ? null : tm;
        b = void 0 === b ? {} : b;
        var d = Math.round(b.timestamp || P());
        F(a, 1, d < Number.MAX_SAFE_INTEGER ? d : 0);
        var e = um();
        d = new th;
        F(d, 1, b.timestamp || !isFinite(e) ? -1 : e);
        if (N("log_sequence_info_on_gel_web") && b.ma) {
            e = b.ma;
            var f = on(e),
                g = new sh;
            F(g, 2, f);
    ...
    function sn(a, b) {
        var c = void 0 === c ? {} : c;
        if (N("migrate_events_to_ts")) {
            c = void 0 === c ? {} : c;
            var d = tm;
            L("ytLoggingEventsDefaultDisabled", !1) && tm === tm && (d = null);
            nn(a, b, d, c)
        } else d = tm, L("ytLoggingEventsDefaultDisabled", !1) && tm == tm && (d = null), nn(a, b, d, c)
    };
    var tn = [{
        Ea: function(a) {
    ...
    function yn() {
        if (!xn) {
            ...
            a.U.length = 0;
            a.S.length = 0;
            vn.U && a.U.push.apply(a.U, vn.U);
            vn.S && a.S.push.apply(a.S, vn.S)
        }
        return xn
    };
    var zn = new J;
    ...
    function Cn(a, b, c, d) {
        if (a)
            if (Array.isArray(a)) {
                var e = d;
                for (d = 0; d < a.length && !(a[d] && (e += Dn(d, a[d], b, c), 500 < e)); d++);
                d = e
            ...
            for (e in a) {
                if (a[e]) {
                    ...
                    var g = b;
                    var h = c;
                    g = "string" !== typeof f || "clickTrackingParams" !== e && "trackingParams" !== e ? 0 : (f = An(atob(f.replace(/-/g, "+").replace(/_/g, "/")))) ? Dn(e + ".ve", f, g, h) : 0;
                    d += g;
                    d += Dn(e, a[e], b, c);
                    if (500 < d) break
                }
    ...
    function Sn() {
        for (var a = u(Qn), b = a.next(); !b.done; b = a.next()) b = b.value, b()
    }
    ...
    function Wn(a, b, c) {
        Xn || (Xn = {}, Uh(window, "message", function(d) {
            a: {
                if (d.origin === Z(a, "host")) {
                    ...
                    if (d = Xn[e.id]) d.v = !0, d.v && (D(d.s, d.sendMessage, d), d.s.length = 0), d.La(e)
                }
                e = void 0
            }
            return e
    ...
    n.destroy = function() {
        ...
        } else(a = this.i) && a.parentNode && a.parentNode.removeChild(a);
        Xn && (Xn[this.id] = null);
        this.j = null;
        a = this.i;
        for (var c in kb) kb[c][0] == a && Sh(c);
        this.o = this.i = null
    };
    n.Oa = function() {
        return {}
    ...
    function co(a, b, c) {
        ...
        a.v ? a.sendMessage(b) : a.s.push(b)
    }
    ...
    function eo(a, b) {
        ...
        c.setAttribute("title", "YouTube " + Z(a.j, "title"));
        (b = Z(a.j, "width")) && c.setAttribute("width", b.toString());
        (b = Z(a.j, "height")) && c.setAttribute("height",
            b.toString());
        var g = a.Oa();
        ...
        window.location.href && D(["debugjs", "debugcss"], function(k) {
            var l = Wb(window.location.href, k);
            null !== l && (g[k] = l)
        });
        Yn.yt_embedsTokenValue && (g.embedsTokenValue = encodeURIComponent(Yn.yt_embedsTokenValue), delete Yn.yt_embedsTokenValue);
        var h = "" + Z(a.j, "host") + ("/embed/" + Z(a.j, "videoId")) + "?" + Ub(g);
        Yn.yt_embedsEnableUaChProbe ? Mn().then(function(k) {
                var l = new URL(h),
                ...
                k = Nd(l.href).toString();
                Ad(c, Od(k));
                return k
            }) :
            Yn.yt_embedsEnableIframeSrcWithIntent ? Ad(c, Od(h)) : c.src = h;
        return c
    }
    n.Xa = function() {
    ...
    n.setup = function(a, b) {
        ...
        if (a = "string" === typeof a ? c.getElementById(a) : a)
            if (c = "iframe" === a.tagName.toLowerCase(), b.host || (b.host = c ? Sb(a.src) : "https://www.youtube.com"), this.j = new Vn(b), c || (b = eo(this, a), this.o = a, (c = a.parentNode) && c.replaceChild(b, a), a = b), this.i = a, this.i.id || (this.i.id = "widget" + Qa(this.i)), Pn[this.i.id] = this, window.postMessage) {
                this.m = new J;
                fo(this);
                b = Z(this.j, "events");
                for (var d in b) b.hasOwnProperty(d) && this.addEventListener(d, b[d]);
                for (var e in Rn) Rn.hasOwnProperty(e) &&
                    bo(this, e)
            }
    };

    function ao(a, b) {
        a.J[b] || (a.J[b] = !0, co(a, "addEventListener", [b]))
    }
    n.sendMessage = function(a) {
        a.id = this.id;
        a.channel = "widget";
        var b = JSON.stringify(a),
            c = [Sb(this.i.src || "").replace("http:", "https:")];
        if (this.i.contentWindow)
            for (var d = 0; d < c.length; d++) try {
                this.i.contentWindow.postMessage(b, c[d])
            } catch (ac) {
                if (ac.name && "SyntaxError" === ac.name) {
                    if (!(ac.message && 0 < ac.message.indexOf("target origin ''"))) {
                        var e = void 0,
                            f = ac;
                        e = void 0 === e ? {} : e;
                        e.name = L("INNERTUBE_CONTEXT_CLIENT_NAME", 1);
                        e.version = L("INNERTUBE_CONTEXT_CLIENT_VERSION");
                        var g = e || {},
                            h = "WARNING";
                        h = void 0 === h ? "ERROR" :
                            h;
                        if (f) {
                            ...
                            if (!(5 <= Gn)) {
                                ...
                                var O = y.lineNumber || "Not available",
                                    nb = y.fileName || "Not available",
                                    Ac = K,
                                    va = 0;
                                if (t.hasOwnProperty("args") && t.args && t.args.length)
                                    for (var pa = 0; pa < t.args.length && !(va = Cn(t.args[pa], "params." + pa, p, va), 500 <= va); pa++);
                                ...
                                if (Jn.length)
                                    for (var W = 0; W < Jn.length && !(va = Cn(Jn[W], "params.context." + W, p, va), 500 <= va); W++);
                                ...
                                if ("IGNORED" === t.level) m = 0;
                                    ...
                                    for (var Rj = yn(), Sj = u(Rj.U), Rf = Sj.next(); !Rf.done; Rf = Sj.next()) {
                                        var Tj = Rf.value;
                                        if (S.message && S.message.match(Tj.Vb)) {
                                            m = Tj.weight;
                                            break a
                                        }
                                    }
                                    for (var Uj = u(Rj.S), Sf = Uj.next(); !Sf.done; Sf = Uj.next()) {
                                        var Vj = Sf.value;
                                        if (Vj.kb(S)) {
                                            m = Vj.weight;
                                            break a
                                ...
                                S.sampleWeight = m;
                                for (var Wj = u(tn), Tf = Wj.next(); !Tf.done; Tf = Wj.next()) {
                                    var Uf = Tf.value;
                                    if (Uf.wa[S.name])
                                        for (var Xj = u(Uf.wa[S.name]), Vf = Xj.next(); !Vf.done; Vf = Xj.next()) {
                                            var Yj = Vf.value,
                                                Td = S.message.match(Yj.regexp);
                                            if (Td) {
                                                S.params["params.error.original"] = Td[0];
                                                for (var Wf = Yj.groups, Zj = {}, bc = 0; bc < Wf.length; bc++) Zj[Wf[bc]] = Td[bc + 1], S.params["params.error." + Wf[bc]] = Td[bc + 1];
                                                S.message = Uf.Ea(Zj);
                                                break
                                            }
                                        }
                                ...
                                S.params || (S.params = {});
                                var ak = yn();
                                S.params["params.errorServiceSignature"] = "msg=" + ak.U.length + "&cb=" + ak.S.length;
                                ...
                                if (0 !== ra.sampleWeight && !Fn.has(ra.message)) {
                                    if ("ERROR" === h) {
                                        zn.da("handleError",
                                            ra);
                                        if (N("record_app_crashed_web") && 0 === In && 1 === ra.sampleWeight)
                                            if (In++, N("errors_via_jspb")) {
                                                var Xf = new rh;
                                                F(Xf, 1, 1);
                                                if (!N("report_client_error_with_app_crash_ks")) {
                                                    var bk = new mh;
                                                    F(bk, 1, ra.message);
                                                    var ck = new nh;
                                                    H(ck, mh, 3, bk);
                                                ...
                                                N("report_client_error_with_app_crash_ks") || (gk.systemHealth = {
                                                    crashData: {
                                                        clientError: {
                                                            logMessage: {
                                                                message: ra.message
                                        ...
                                        Hn++
                                    } else "WARNING" === h && zn.da("handleWarning", ra);
                                    if (N("kevlar_gel_error_routing")) a: {
                                        var Yf = void 0,
                                            Zf = void 0,
                                            Mc = h,
                                            Q = ra;
                                        if (N("errors_via_jspb")) {
                                            if (Ln()) Zf = void 0;
                                                ...
                                                var cc = new jh;
                                                F(cc, 1, Q.stack);
                                                Q.fileName && F(cc, 4, Q.fileName);
                                                var Na = Q.lineNumber && Q.lineNumber.split ? Q.lineNumber.split(":") : [];
                                                0 !== Na.length && (1 !== Na.length || isNaN(Number(Na[0])) ? 2 !== Na.length || isNaN(Number(Na[0])) || isNaN(Number(Na[1])) || (F(cc, 2, Number(Na[0])), F(cc, 3, Number(Na[1]))) : F(cc, 2, Number(Na[0])));
                                                var sb =
                                                    new mh;
                                                F(sb, 1, Q.message);
                                                F(sb, 3, Q.name);
                                                F(sb, 6, Q.sampleWeight);
                                                "ERROR" === Mc ? F(sb, 2, 2) : "WARNING" === Mc ? F(sb, 2, 1) : F(sb, 2, 0);
                                                var $f = new kh;
                                                F($f, 1, !0);
                                                kd($f, jh, 3, lh, cc);
                                                var tb = new gh;
                                                F(tb, 3, window.location.href);
                                                for (var hk = L("FEXP_EXPERIMENTS", []), ag = 0; ag < hk.length; ag++) {
                                                    var ik = tb,
                                                        mo = hk[ag];
                                                    Sc(ik);
                                                    fd(ik, 5).push(mo)
                                                ...
                                                var bg = Gh();
                                                if (!Hh() && bg)
                                                    for (var jk = u(Object.keys(bg)), ub = jk.next(); !ub.done; ub = jk.next()) {
                                                        var kk = ub.value,
                                                            cg = new ih;
                                                        F(cg, 1, kk);
                                                        cg.setValue(String(bg[kk]));
                                                        md(tb, 4, ih, cg)
                                                    }
                                                var dg = Q.params;
                                                if (dg) {
                                                    var lk =
                                                        u(Object.keys(dg));
                                                    for (ub = lk.next(); !ub.done; ub = lk.next()) {
                                                        var mk = ub.value,
                                                            eg = new ih;
                                                        F(eg, 1, "client." + mk);
                                                        eg.setValue(String(dg[mk]));
                                                        md(tb, 4, ih, eg)
                                                    }
                                                }
                                                var nk = L("SERVER_NAME"),
                                                    ok = L("SERVER_VERSION");
                                                if (nk && ok) {
                                                    var fg = new ih;
                                                    F(fg, 1, "server.name");
                                            ...
                                            if (Ln()) Yf = void 0;
                                                ...
                                                Q.fileName && (Nc.filename = Q.fileName);
                                                var Oa = Q.lineNumber && Q.lineNumber.split ? Q.lineNumber.split(":") : [];
                                                0 !== Oa.length && (1 !== Oa.length || isNaN(Number(Oa[0])) ? 2 !== Oa.length || isNaN(Number(Oa[0])) || isNaN(Number(Oa[1])) || (Nc.lineNumber = Number(Oa[0]), Nc.columnNumber = Number(Oa[1])) : Nc.lineNumber = Number(Oa[0]));
                                                var hg = {
                                                ...
                                                "ERROR" === Mc ? hg.level = "ERROR_LEVEL_ERROR" : "WARNING" === Mc && (hg.level = "ERROR_LEVEL_WARNNING");
                                                var no = {
                                                        isObfuscated: !0,
                                                        browserStackInfo: Nc
                                                    },
                                                ...
                                                L("FEXP_EXPERIMENTS") && (dc.experimentIds = L("FEXP_EXPERIMENTS"));
                                                var ig = Gh();
                                                if (!Hh() && ig)
                                                    for (var rk = u(Object.keys(ig)), vb = rk.next(); !vb.done; vb = rk.next()) {
                                                        var sk = vb.value;
                                                        dc.kvPairs.push({
                                                            key: sk,
                                                            value: String(ig[sk])
                                                ...
                                                var jg = Q.params;
                                                if (jg) {
                                                    var tk = u(Object.keys(jg));
                                                    for (vb = tk.next(); !vb.done; vb = tk.next()) {
                                                        var uk = vb.value;
                                                        dc.kvPairs.push({
                                                            key: "client." + uk,
                                                            value: String(jg[uk])
                                                ...
                                                var vk = L("SERVER_NAME"),
                                                    wk = L("SERVER_VERSION");
                                                vk && wk && (dc.kvPairs.push({
                                                    key: "server.name",
                                                    value: vk
                                                }), dc.kvPairs.push({
                                                    key: "server.version",
                                        ...
                                        if ("ERROR" === Mc || N("errors_flush_gel_always_killswitch")) b: if (N("migrate_events_to_ts")) c: {
                                            if (N("web_fp_via_jspb") && (pn(!0), !N("web_fp_via_jspb_and_json"))) break c;pn()
                                        }
                                        else {
                                            if (N("web_fp_via_jspb") && (pn(!0), !N("web_fp_via_jspb_and_json"))) break b;
                                            pn()
                                        }
                                    }
                                    if (!N("suppress_error_204_logging")) {
                                        ...
                                        Oc.version && (ab["client.version"] = Oc.version);
                                        if (ab.postParams) {
                                            wb.stack && (ab.postParams.stack = wb.stack);
                                            for (var yk = u(Object.keys(Oc)), kg = yk.next(); !kg.done; kg = yk.next()) {
                                                var zk = kg.value;
                                                ab.postParams["client." + zk] = Oc[zk]
                                            }
                                            var lg = Gh();
                                            if (lg)
                                                for (var Ak = u(Object.keys(lg)),
                                                        mg = Ak.next(); !mg.done; mg = Ak.next()) {
                                                    var Bk = mg.value;
                                                    ab.postParams[Bk] = lg[Bk]
                                                }
                                            var Ck = L("SERVER_NAME"),
                                                Dk = L("SERVER_VERSION");
                                            Ck && Dk && (ab.postParams["server.name"] = Ck, ab.postParams["server.version"] = Dk)
                                        }
                                        ri(L("ECATCHER_REPORT_HOST", "") + "/error_204", ab)
                                    }
                                    try {
                                        Fn.add(ra.message)
                                    } catch (so) {}
    ...
    n = io.prototype;
    n.Oa = function() {
        var a = Z(this.j, "playerVars");
        a ? a = mb(a) : a = {};
        window !== window.top && document.referrer && (a.widget_referrer = document.referrer.substring(0, 256));
        var b = Z(this.j, "embedConfig");
        if (b) {
            if (Pa(b)) try {
                b = JSON.stringify(b)
            } catch (c) {
                console.error("Invalid embed config JSON", c)
            }
            a.embed_config = b
        }
        return a
    ...
    n.La = function(a) {
        ...
        switch (b) {
            ...
            case "initialDelivery":
                Pa(a) && (window.clearInterval(this.l), this.playerInfo = {}, this.M = {}, ko(this, a.apiInterface), jo(this, a));
                break;
            default:
                $n(this, b, a)
        }
    ...
    function jo(a, b) {
        if (Pa(b)) {
            ...
            a.playerInfo.hasOwnProperty("videoData") && (b = a.playerInfo.videoData, b.hasOwnProperty("title") && b.title ? (b = b.title, b !== a.videoTitle && (a.videoTitle = b, a.i.setAttribute("title", b))) : (a.videoTitle = "", a.i.setAttribute("title", "YouTube " + Z(a.j, "title"))))
        }
    }
    ...
    n.getVideoEmbedCode = function() {
        var a = Z(this.j, "host") + ("/embed/" + Z(this.j, "videoId")),
            b = Number(Z(this.j, "width")),
            c = Number(Z(this.j, "height"));
        if (isNaN(b) || isNaN(c)) throw Error("Invalid width or height property");
        b = Math.floor(b);
        c = Math.floor(c);
        var d = this.videoTitle;
        Hb.test(a) && (-1 != a.indexOf("&") && (a = a.replace(Bb, "&amp;")), -1 != a.indexOf("<") && (a = a.replace(Cb, "&lt;")), -1 != a.indexOf(">") && (a = a.replace(Db, "&gt;")), -1 != a.indexOf('"') && (a = a.replace(Eb, "&quot;")), -1 != a.indexOf("'") && (a = a.replace(Fb, "&#39;")), -1 != a.indexOf("\x00") && (a = a.replace(Gb, "&#0;")));
    ...
    C("YT.subscribe", function(a, b, c) {
        Bg.subscribe(a, b, c);
        Rn[a] = !0;
        for (var d in Pn) Pn.hasOwnProperty(d) && bo(Pn[d], a)
    });
    ...
    Zn.prototype.setSize = Zn.prototype.setSize;
    Zn.prototype.getIframe = Zn.prototype.getIframe;
    Zn.prototype.addEventListener = Zn.prototype.addEventListener;
    io.prototype.getVideoEmbedCode = io.prototype.getVideoEmbedCode;
    io.prototype.getOptions = io.prototype.getOptions;
    io.prototype.getOption = io.prototype.getOption;
    Qn.push(function(a) {
        var b = a;
        b || (b = document);
    ...
    var po = A.onYTReady;
    po && po();
    var qo = A.onYouTubeIframeAPIReady;
    qo && qo();
    var ro = A.onYouTubePlayerAPIReady;
    ro && ro();
}).call(this);